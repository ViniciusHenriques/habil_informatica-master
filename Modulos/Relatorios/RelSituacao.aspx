<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPrincipal.Master" AutoEventWireup="true" CodeBehind="RelSituacao.aspx.cs" Inherits="HabilInformatica.Relatorios.RelSituacao" %>
                    ...
                    <tr>
                        <td width="760px">
                          <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="100%" SizeToReportContent="True" Height="100%" ZoomMode="Percent">
                                <LocalReport ReportPath="Relatorios\RLDC\RelSituacao.rdlc">
                                </LocalReport>
                            </rsweb:ReportViewer>
                        </td>
                    </tr>
