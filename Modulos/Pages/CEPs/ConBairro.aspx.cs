...
{
    public partial class ConBairro : System.Web.UI.Page
    {
        ...
        protected void MontaFiltro(object sender, EventArgs e)
        {
            ...
            Lista = d.ListarCamposSQL("BAIRRO");
        ...
        protected void btnConsultar_Click(object sender, EventArgs e)
        {
            ...
            {
                strTipo = d.ListarTipoCampoSQL("BAIRRO", lblFiltro1.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoSQL("BAIRRO", lblFiltro2.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoSQL("BAIRRO", lblFiltro3.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoSQL("BAIRRO", lblFiltro4.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoSQL("BAIRRO", lblFiltro5.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoSQL("BAIRRO", lblFiltro6.ToolTip).ToString().ToUpper();
            ...
            grdGrid.DataSource = r.ListarBairrosCompleto(lista);
            grdGrid.DataBind();
            if (grdGrid.Rows.Count == 0)
                ShowMessage("Bairro(s) não encontrado(s) mediante a pesquisa realizada.",MessageType.Info);

        }
        protected void grdGrid_SelectedIndexChanged(object sender, EventArgs e)
        {
            Session["ZoomBairro"] = HttpUtility.HtmlDecode(grdGrid.SelectedRow.Cells[0].Text) + "³";
            Response.Redirect("~/Pages/CEPs/CadBairro.aspx");
        }
