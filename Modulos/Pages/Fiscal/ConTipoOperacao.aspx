<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPrincipal.Master" AutoEventWireup="true" CodeBehind="ConTipoOperacao.aspx.cs" Inherits="SoftHabilInformatica.Pages.Fiscal.ConTipoOperacao" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cttCorpo" runat="server" onFocus="this.select()">
    ...
    <div id="divNavTeste" style="padding-left:20px;padding-top:20px;padding-right:20px" >
        ...
        <div class="panel panel-primary" >
            <div  class="panel-heading">Consulta de Tipos de Operação
                <div class="messagealert" id="alert_container"></div>
            </div>
            <div class="panel-body">
                <asp:LinkButton ID="btnVoltar" runat="server" Text="Novo" CssClass="btn btn-info" UseSubmitBehavior="false" OnClick="btnVoltar_Click"> 
                    <span aria-hidden="true" title="Novo" class="glyphicon glyphicon-arrow-left"></span>  Voltar
                </asp:LinkButton>
                <asp:LinkButton ID="btnNovo" runat="server" onFocus="this.select()" Text="Novo" CssClass="btn btn-info" UseSubmitBehavior="false" OnClick="btnNovo_Click"> 
                ...
                <div id="Tabs" role="tabpanel">
                    ...
                    <div class="tab-content" runat="server" onFocus="this.select()" id="PanelContext">
                        ...
                        <div role="tabpanel" class="tab-pane" id="consulta" style="padding-left:20px;padding-top:20px;padding-right:20px;font-size:small;"  >
                            <asp:LinkButton ID="btnVoltarSelecao" runat="server" onFocus="this.select()" Text="Nova Consulta" CssClass="btn btn-default" UseSubmitBehavior="false" OnClick="btnVoltarSelecao_Click"> 
                                <span aria-hidden="true" title="Novo" class="glyphicon glyphicon-edit"></span>Nova Consulta
                            </asp:LinkButton>
                            <br/>
                            <br/>
                            <asp:GridView ID="grdGrid" runat="server" onFocus="this.select()" CssClass="table table-bordered table-hover table-striped"
                                ...
                                <Columns>
                                    <asp:BoundField DataField="CodigoTipoOperacao" HeaderText="Código" />
                                    <asp:BoundField DataField="DescricaoTipoOperacao" HeaderText="Descrição" />
