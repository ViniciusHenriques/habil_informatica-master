...
{
    public partial class ConNatOperacao : System.Web.UI.Page
    {
        ...
        protected void MontaFiltro(object sender, EventArgs e)
        {
            ...
            Lista = d.ListarCamposSQL("NATUREZA_DA_OPERACAO");
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Session["TabFocadaNatOp"] != null)
                PanelSelect = Session["TabFocadaNatOp"].ToString();
            else
                if (!IsPostBack)
            {
                PanelSelect = "home";
                Session["TabFocadaNatOp"] = "home";
            }
            ...
            if (Session["LST_NATOP"] != null)
            {
                listaT = (List<DBTabelaCampos>)Session["LST_NATOP"];
                if (listaT.Count != 0)
        ...
        protected void btnConsultar_Click(object sender, EventArgs e)
        {
            ...
            {
                strTipo = d.ListarTipoCampoSQL("NATUREZA_DA_OPERACAO", lblFiltro1.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoSQL("NATUREZA_DA_OPERACAO", lblFiltro2.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoSQL("NATUREZA_DA_OPERACAO", lblFiltro3.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoSQL("NATUREZA_DA_OPERACAO", lblFiltro4.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoSQL("NATUREZA_DA_OPERACAO", lblFiltro5.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoSQL("NATUREZA_DA_OPERACAO", lblFiltro6.ToolTip).ToString().ToUpper();
            ...
            Session["LST_NATOP"] = listaT;
            NatOperacaoDAL r = new NatOperacaoDAL();
            grdGrid.DataSource = r.ListarNatOperacoesCompleto(listaT);
            grdGrid.DataBind();
            if (grdGrid.Rows.Count == 0)
            {
                ShowMessage("Natureza(s) da Operação não encontrada(s) mediante a pesquisa realizada.", MessageType.Info);
                Session["LST_NATOP"] = null;
            }
        }
        protected void grdGrid_SelectedIndexChanged(object sender, EventArgs e)
        {          
            Session["ZoomNatOperacao"] = HttpUtility.HtmlDecode(grdGrid.SelectedRow.Cells[0].Text) + "³";
            Response.Redirect("~/Pages/Fiscal/CadNatOperacao.aspx");
        }
