<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPrincipal.Master" AutoEventWireup="true" CodeBehind="ConNatOperacao.aspx.cs" Inherits="SoftHabilInformatica.Pages.Fiscal.ConNatOperacao" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cttCorpo" runat="server">
    ...
    <div id="divNavTeste" style="padding-left:20px;padding-top:20px;padding-right:20px" >
        ...
        <div class="panel panel-primary" >
            <div  class="panel-heading">Consulta de Naturezas de Operação
                    ...
                    <div class="tab-content" runat="server" id="PanelContext">
                        ...
                        <div role="tabpanel" class="tab-pane" id="consulta" style="padding-left:20px;padding-top:20px;padding-right:20px;font-size:small;"   >
                            ...
                            <asp:GridView ID="grdGrid" runat="server" CssClass="table table-bordered table-hover table-striped"
                                ...
                                <Columns>
                                    <asp:BoundField DataField="CodigoNaturezaOperacao" HeaderText="Código" />
                                    
                                    <asp:BoundField DataField="DescricaoNaturezaOperacao" HeaderText="Descrição" />
                                    <asp:BoundField DataField="CodigoNaturezaOperacaoContraPartida" HeaderText="Codigo Contra" />
                                    <asp:BoundField DataField="CodigoNaturezaOperacaoST" HeaderText="Código ST" />
