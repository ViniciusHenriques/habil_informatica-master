<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPrincipal.Master" AutoEventWireup="true" 
    CodeBehind="ManItemOrdCompra.aspx.cs" Inherits="SoftHabilInformatica.Pages.Compras.ManItemOrdCompra" 
    ...
    <div id="divNavTeste" style="padding-left: 20px; padding-top: 20px; padding-right: 20px;"  >
        <div class="panel panel-primary">
            <div class="panel-heading" >
                Manutenção dos Itens da Ordem de Compra
            ...
            <div class="panel-body" >
                ...
                <div class="row" style="background-color: white; border: none; margin-top:10px!important">
                    <asp:HiddenField ID="TabName" runat="server"/>            
                        ...
                        <asp:Panel ID="pnlBiConsumo" runat="server">
                            <div class="col-md-12" style="background-color: white; border: none; text-align: left; font-size: small; margin-top:5px">                                                                                                 
                                <div class="panel panel-default" >
                                    <div class="panel-heading" style="padding-left:25px" >
                                                                        ...
                                                                        <asp:GridView ID="grdBIConsumoPessoaProduto" runat="server" Width="100%" 
                                                                            ...
                                                                            <Columns>    
                                                                                ...
                                                                                <asp:TemplateField HeaderText="Qtde. Comprar"  ItemStyle-CssClass="col-md-1" HeaderStyle-CssClass="text-align-center">
                                                                                    <ItemTemplate>
                                                                                        <asp:TextBox ID="txtQtdaComprarDep1" CssClass="form-control"  runat="server" Text='<%# Eval("QuantidadeComprar").ToString() %>' OnTextChanged="txtQtdaComprarDep1_TextChanged" AutoPostBack="true" onFocus="this.select()" MaxLength="15"/>
                                                                                    </ItemTemplate>
                                                                                </asp:TemplateField>
                                                                            </Columns>
                                                                            <RowStyle CssClass="cursor-pointer" />
                                                                    ...
                                                                    <ContentTemplate> 
                                                                        <asp:GridView ID="grdBIConsumoPessoaProduto2" runat="server" Width="100%" 
                                                                            ...
                                                                            <Columns>    
                                                                                ...
                                                                                <asp:TemplateField HeaderText="Qtde. Comprar"  ItemStyle-CssClass="col-md-1" HeaderStyle-CssClass="text-align-center">
                                                                                    <ItemTemplate>
                                                                                        <asp:TextBox ID="txtQtdaComprarDep2" CssClass="form-control"  runat="server" Text='<%# Eval("QuantidadeComprar").ToString() %>' OnTextChanged="txtQtdaComprarDep2_TextChanged" AutoPostBack="true" onFocus="this.select()" MaxLength="15"/>
                                                                                    </ItemTemplate>
                                                                                </asp:TemplateField>
                                                                            </Columns>
                                                                            <RowStyle CssClass="cursor-pointer" />
                                                                    ...
                                                                    <ContentTemplate> 
                                                                        <asp:GridView ID="grdBIConsumoPessoaProduto3" runat="server" Width="100%" 
                                                                            ...
                                                                            <Columns>    
                                                                                ...
                                                                                <asp:TemplateField HeaderText="Qtde. Comprar"  ItemStyle-CssClass="col-md-1" HeaderStyle-CssClass="text-align-center">
                                                                                    <ItemTemplate>
                                                                                        <asp:TextBox ID="txtQtdaComprarDep3" CssClass="form-control"  runat="server" Text='<%# Eval("QuantidadeComprar").ToString() %>' OnTextChanged="txtQtdaComprarDep3_TextChanged" AutoPostBack="true" onFocus="this.select()" MaxLength="15"/>
                                                                                    </ItemTemplate>
                                                                                </asp:TemplateField>
                                                                            </Columns>
                                                                            <RowStyle CssClass="cursor-pointer" />
                                                                    ...
                                                                    <ContentTemplate> 
                                                                        <asp:GridView ID="grdBIConsumoPessoaProduto4" runat="server" Width="100%" 
                                                                            ...
                                                                            <Columns>    
                                                                                ...
                                                                                <asp:TemplateField HeaderText="Qtde. Comprar"  ItemStyle-CssClass="col-md-1" HeaderStyle-CssClass="text-align-center">
                                                                                    <ItemTemplate>
                                                                                        <asp:TextBox ID="txtQtdaComprarDep4" CssClass="form-control"  runat="server" Text='<%# Eval("QuantidadeComprar").ToString() %>' OnTextChanged="txtQtdaComprarDep4_TextChanged" AutoPostBack="true" onFocus="this.select()" MaxLength="15"/>
                                                                                    </ItemTemplate>
                                                                                </asp:TemplateField>
                                                                            </Columns>
                                                                            <RowStyle CssClass="cursor-pointer" />
                                                                    ...
                                                                    <ContentTemplate> 
                                                                        <asp:GridView ID="grdBIConsumoPessoaProduto5" runat="server" Width="100%" 
                                                                            ...
                                                                            <Columns>    
                                                                                ...
                                                                                <asp:TemplateField HeaderText="Qtde. Comprar"  ItemStyle-CssClass="col-md-1" HeaderStyle-CssClass="text-align-center">
                                                                                    <ItemTemplate>
                                                                                        <asp:TextBox ID="txtQtdaComprarDep5" CssClass="form-control"  runat="server" Text='<%# Eval("QuantidadeComprar").ToString() %>' OnTextChanged="txtQtdaComprarDep5_TextChanged" AutoPostBack="true" onFocus="this.select()" MaxLength="15"/>
                                                                                    </ItemTemplate>
                                                                                </asp:TemplateField>
                                                                            </Columns>
                                                                            <RowStyle CssClass="cursor-pointer" />
                                                                    ...
                                                                    <ContentTemplate> 
                                                                        <asp:GridView ID="grdBIConsumoPessoaProduto6" runat="server" Width="100%" 
                                                                            ...
                                                                            <Columns>    
                                                                                ...
                                                                                <asp:TemplateField HeaderText="Qtde. Comprar"  ItemStyle-CssClass="col-md-1" HeaderStyle-CssClass="text-align-center">
                                                                                    <ItemTemplate>
                                                                                        <asp:TextBox ID="txtQtdaComprarDep6" CssClass="form-control"  runat="server" Text='<%# Eval("QuantidadeComprar").ToString() %>' OnTextChanged="txtQtdaComprarDep6_TextChanged" AutoPostBack="true" onFocus="this.select()" MaxLength="15"/>
                                                                                    </ItemTemplate>
                                                                                </asp:TemplateField>
                                                                            </Columns>
                                                                            <RowStyle CssClass="cursor-pointer" />
