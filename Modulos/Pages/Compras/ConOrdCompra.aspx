<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPrincipal.Master" AutoEventWireup="true" CodeBehind="ConOrdCompra.aspx.cs" 
    Inherits="SoftHabilInformatica.Pages.Compras.ConOrdCompra"  MaintainScrollPositionOnPostback="True" %>
    ...
    <div id="divNavTeste" style="padding-left: 20px; padding-top: 20px; padding-right: 20px">
        <div class="panel panel-primary" >
            <div  class="panel-heading">
                <div>Consulta de Ordem de Compra</div><a href="https://www.youtube.com/watch?v=alg7nQ0WG7c" target="_blank" style="float:right;margin-top:-21px"  title="Ajuda"><img src="../../Images/Help.svg" title="Ajuda"/></a>
                            ...
                            <asp:UpdatePanel ID="InsertEmployeeUpdatePanel" runat="server" UpdateMode="Always">
                                <ContentTemplate>
                                    <div class="row" style="background-color:white;border:none;">                                       
                                        ...
                                        <div class="col-md-6" >
                                            <div class="input-group">
                                                <span class="input-group-addon">Tipo Orçamento: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                                <asp:DropDownList ID="ddlTipoOrcamento" CssClass="form-control js-example-basic-single" runat="server" Font-Size="Small" Width="100%" >
                                           ...
                                           <div class="col-md-3" >
                                                <div class="input-group">
                                                    ...
                                                    <asp:DropDownList ID="ddlSituacao" CssClass="form-control" runat="server" Font-Size="Medium" >
                                                        ...
                                                        <asp:ListItem Value="138" Text="Baixado SV"></asp:ListItem>
                                                        <asp:ListItem Value="144" Text="Baixado Parcial"></asp:ListItem>
                                                    </asp:DropDownList>
                                                </div>
                                            </div>
                                ...
                                <ContentTemplate>
                                    <asp:GridView ID="grdGrid" runat="server" CssClass="table table-bordered table-striped" Width="100%" 
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="ValorFrete" HeaderText="Frete"  DataFormatString="{0:C}" ItemStyle-CssClass="padding-top-15 noprint" HeaderStyle-CssClass="noprint"/>   
                                                ...
                                                <ItemTemplate>
                                                    <div class="dropdown">  
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-right">
                                                            ...
                                                            <li><a><asp:linkButton runat="server" ID="LinkButton2" CssClass="listButton" 
                                                                Text="Gerar Pedido"
                                                                CommandName="GerarPedido" AutoPostBack="true" Visible='<%# Eval("PodeGerarPedido") %>'
                                                                CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" ><span class="glyphicon glyphicon-pencil" style="margin-right:10px!important;"></span>Gerar Pedido</asp:linkButton></a></li>
