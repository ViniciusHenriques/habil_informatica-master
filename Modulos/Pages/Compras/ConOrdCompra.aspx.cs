...
{
    public partial class ConOrdCompra : System.Web.UI.Page
    {
        ...
        protected void MontaFiltro(object sender, EventArgs e)
        {
            ...
            Lista = d.ListarCamposView("VW_DOC_ORD_COMPRA");
        ...
        protected void btnConsultar_Click(object sender, EventArgs e)
        {
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_DOC_ORD_COMPRA", lblFiltroData1.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_DOC_ORD_COMPRA", lblFiltroData2.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_DOC_ORD_COMPRA", lblFiltroData3.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_DOC_ORD_COMPRA", lblFiltro1.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_DOC_ORD_COMPRA", lblFiltro2.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_DOC_ORD_COMPRA", lblFiltro3.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_DOC_ORD_COMPRA", lblFiltro4.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_DOC_ORD_COMPRA", lblFiltro5.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_DOC_ORD_COMPRA", lblFiltro6.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_DOC_ORD_COMPRA", lblFiltro7.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_DOC_ORD_COMPRA", lblFiltro8.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_DOC_ORD_COMPRA", lblFiltro9.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_DOC_ORD_COMPRA", lblFiltro10.ToolTip).ToString().ToUpper();
            ...
            Doc_OrdCompraDAL r = new Doc_OrdCompraDAL();
            grdGrid.DataSource = r.ListarOrdemComprasCompleto(listaT);
            grdGrid.DataBind();

            if (grdGrid.Rows.Count == 0)
            {
                ShowMessage("Orden(s) de Compra não encontrado(s) mediante a pesquisa realizada.", MessageType.Info);
                Session["LST_ORCAMENTO"] = null;
            }
        }
        ...
        protected void grdGrid_SelectedIndexChanged(object sender, GridViewCommandEventArgs e)
        {
            ...
            else if (x == "Imprimir")
            {
                ...
                Response.Redirect("~/Pages/Compras/RelOrcamento.aspx");                        
        ...
        protected void OpDuplicar_CommandRow(object sender, EventArgs e)
        {
            ...
            doc = docDAL.PesquisarOrdemCompra(codigo);
