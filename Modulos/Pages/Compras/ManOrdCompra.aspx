<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPrincipal.Master" AutoEventWireup="true" 
    CodeBehind="ManOrdCompra.aspx.cs" Inherits="SoftHabilInformatica.Pages.Compras.ManOrdCompra" 
...
<asp:Content ID="Content1" ContentPlaceHolderID="cttCorpo" runat="server" >
    ...
    <script>
        ...
        $(document).on('keydown', function (e) {
            if ((e.altKey) && (e.which === 65)) { 
                ...
                $get('<%=btnGerarPedido.ClientID%>').click(); 
            }
            else if ((e.altKey) && (e.which === 66)) { 
                $get('<%=btnBaixarSV.ClientID%>').click(); 
            }
            else if ((e.altKey) && (e.which === 78)) { 
                $get('<%=btnNovoAnexo.ClientID%>').click(); 
            }
            else if ((e.altKey) && (e.which === 80)) { 
                $get('<%=btnBaixarParcial.ClientID%>').click(); 
            }
    ...
    <div id="divNavTeste" style="padding-left: 20px; padding-top: 20px; padding-right: 20px;"  >
        <div class="panel panel-primary">
            <div class="panel-heading" >
                <div class="col-md-4" style="margin-top:5px">Manutenção da Ordem de Compra</div>
                       ...
                       <asp:UpdatePanel ID="UpdatePanel6" runat="server" UpdateMode="Always">
                            <ContentTemplate>
                                <div class="col-md-8" style="background-color: white; border: none; text-align: left; font-size: small;">                           
                                    ...
                                    <asp:LinkButton ID="btnExcluir" runat="server" Text="Excluir" CssClass="btn btn-danger" data-toggle="modal" data-target="#myexcpes" title="Excluir ( Alt + K )" > 
                                        <span aria-hidden="true" title="Excluir ( Alt + K )" class="glyphicon glyphicon-remove"></span>  Excluir
                                    </asp:LinkButton>

                                     <asp:LinkButton ID="btnGerarPedido" runat="server" Text="Gerar pedido" CssClass="btn btn-warning" TabIndex="1"  data-toggle="modal" data-target="#modalGerarPedido"  ToolTip="Gerar pedido a partir deste orçamento ( Alt + G )"> 
                                        <span aria-hidden="true" class="glyphicon glyphicon-pencil"></span>  Gerar pedido
                                    </asp:LinkButton>
                                     <asp:LinkButton ID="btnBaixarSV" runat="server" CssClass="btn alert-info" TabIndex="1" data-toggle="modal" data-target="#modalBaixarSemVenda" ToolTip="Baixar orçamento sem venda  ( Alt + B )" > 
                                        <span aria-hidden="true" class="glyphicon glyphicon-arrow-down"></span> Baixar SV
                                    </asp:LinkButton>
                                     <asp:LinkButton ID="btnBaixarParcial" runat="server" CssClass="btn alert-info" TabIndex="1" data-toggle="modal" data-target="#modalBaixarParcial" ToolTip="Baixar orçamento parcialmente ( Alt + P )"> 
                                        <span aria-hidden="true" class="glyphicon glyphicon-arrow-down"></span> Baixar parcial
                                    </asp:LinkButton>
                                </div>
                            </ContentTemplate> 
                            <Triggers>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel9" runat="server" UpdateMode="Always">
                                <ContentTemplate>
                                    <ul class="nav nav-tabs" role="tablist" id="myTabs">
                                        ...
                                        <li role="presentation" id="abaTagLi6" style="<%=TabLogs%>" title="Alterações feitas no Documento"><a href="#aba6" aria-controls="profile" role="tab" data-toggle="tab" class="tab-select"><span class="glyphicon glyphicon-check"></span>&nbsp;&nbsp;Logs</a></li>
                                        ...
                                        <ContentTemplate>
                                            ...
                                            <div class="row">
                                                <div class="col-md-2" style="font-size: x-small;margin-top:3px">
                                                    <label for="usr" style ="margin-top:1px;">N° Orçamento</label>
                                                ...
                                                <div class="col-md-2" style="font-size: x-small;margin-top:3px">
                                                    ...
                                                    <asp:TextBox ID="txtNroWeb" CssClass="form-control"  TabIndex="21" enabled="false" runat="server" AutoPostBack="true"  MaxLength="12" onFocus="this.select()" OnTextChanged="txtNroWeb_TextChanged"/>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4" style="background-color: white; border: none; text-align: left; font-size: x-small;margin-top:3px">
                                                    ...
                                                    <asp:DropDownList ID="ddlPagamento" runat="server" AutoPostBack="False" Width="100%" TabIndex="13" CssClass="form-control js-example-basic-single" Font-Size="Small"/>
                                                </div> 
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6" >
                                                    ...
                                                    <div class="input-group " style="width:100%">                              
                                                        <asp:TextBox ID="txtCodTransportador" CssClass="form-control"  runat="server" TabIndex="14" OnTextChanged="txtCodTransportador_TextChanged"   AutoPostBack="true"  onFocus="this.select()"                              
                                                        Width="15%" MaxLength="6" />                                                      
                                                ...
                                                <div class="col-md-12 " style="margin-top:6px">
                                                    <div class="panel panel-primary">
                                                        <div class="panel-heading" style="text-align:center;padding:13px!important;height:45px">
                                                            <div class="col-md-2">
                                                                 <asp:LinkButton ID="btnAddItem" runat="server" Text="Voltar" CssClass="btn btn-info" TabIndex="16" UseSubmitBehavior="false"  OnClick="btnAddItem_Click" style="float:left!important;margin-top:-7px!important" title="Editar ( Alt + A )"> 
                                                        ...
                                                        <div class="panel-body scroll-true" style="padding-left:0px!important;padding-right:0px!important;padding-bottom:0px!important">
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:BoundField DataField="Impostos.PercentualICMS" HeaderText="% ICMS"  DataFormatString="{0:F}%"   />
                                                                ...
                                                                <asp:TemplateField HeaderText="Situação" ItemStyle-CssClass="centerVertical col-md-1 padding-top-15">
                                                                    <ItemTemplate>
                                                                        <label class="badge <%# Eval("Cpl_DscSituacao").ToString().Replace(' ','-') %>" id="situacaoSpan"><%# Eval("Cpl_DscSituacao").ToString() %></label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                            </Columns>
                                             ...
                                             <div class="row">
                                                <div class="col-md-12" style="padding:0!important">
                                                    <div class="col-md-3" style="font-size: x-small;">
                                                        <div>
                                                        <label for="usr" style ="margin-top:1px;">Desconto Médio R$ / %</label></div>
                                ...
                                <div role="tabpanel" class="tab-pane" id="aba3" style="padding-left: 20px; padding-top: 20px; padding-right: 20px; font-size: small;">
                                                        ...
                                                        <ContentTemplate>
                                                            ...
                                                            <div class="col-md-12" style="height:10%">
                                                                <div class="input-group" style="height:80%">
                                                                    ...
                                                                    <span class="input-group-addon" style="border-right:0;padding-right:0;color:black;font-weight:bold;font-size:20px" >R$</span>
                                                                    <asp:TextBox ID="txtVlrUsado" AutoPostBack="False" Enabled="false" Height="100%"  CssClass="form-control" TabIndex="8" runat="server" style="border-left:0;color:black;font-weight:bold;padding-left:5px;font-size:20px" />
                                                                </div>                                                  
                                                            </div>
                                                            <br /><br />
                                                            <div class="col-md-12" style="height:10%">
                                                            ...
                                                            <div class="col-md-12" style="height:10%">
                                                                <div class="input-group" style="height:80%">
                                                                    ...
                                                                    <span class="input-group-addon" style="border-right:0;padding-right:0;color:black;font-weight:bold;font-size:20px" >R$</span>
                                                                    <asp:TextBox ID="txtVlrDisponivel"  Enabled="false" AutoPostBack="False" Height="100%"  CssClass="form-control" TabIndex="8" runat="server" style="border-left:0;color:black;font-weight:bold;padding-left:5px;font-size:20px" />
                                                                </div>                                                 
                                                            </div>
                                                        </ContentTemplate> 
                                                    </asp:UpdatePanel>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                             <div class="panel panel-primary">
                                                <div class="panel-heading" style="text-align:center;">
                                                    Detalhes de pagamento - Contas em aberto
                                                </div>
                                                     ...
                                                     <asp:UpdatePanel ID="UpdatePanel12" runat="server" UpdateMode="Always">
                                                        <ContentTemplate>
                                                            <asp:GridView ID="grdConsumo" runat="server"
                                                                    ...
                                                                    OnRowCommand="grdConsumo_SelectedIndexChanged">
                                                                <PagerStyle HorizontalAlign = "left"   CssClass = "GridPager" />
                                                                <Columns>
                                                                            ...
                                                                            <div class="dropdown">  
                                                                                ...
                                                                                <div class="dropdown-menu dropdown-menu-right " style="width:300px!important">
                                                                                    <div class="col-md-12 " >
                                                                                        ...
                                                                                        <p>Peso: <%# Eval("ValorPesoOrcamento").ToString() %> </p>
                                        ...
                                        <ContentTemplate>
                                             <div class="row">
                                                <div class="col-md-12" style="font-size: x-small;margin-top:0px">
                                                 ...
                                                 <div class="col-md-12" style="font-size: x-small;margin-top:0px">
                                                    <label for="usr" style ="margin-top:1px;">Motivo da baixa</label>
                                                    <asp:TextBox ID="txtMotivo" CssClass="form-control" runat="server"  TabIndex="28" TextMode="multiline" Columns="10" Rows="5" MaxLength="300" Enabled="false" />
                                                </div>
                                            </div>
                                        </ContentTemplate> 
                                        <Triggers>
    ...
    <asp:UpdatePanel ID="UpdatePanel8" runat="server" UpdateMode="Always">
     ...
     <asp:UpdatePanel ID="UpdatePanel16" runat="server" UpdateMode="Always">
        <ContentTemplate>
            <div class="modal fade" id="modalGerarPedido" tabindex="-1" role="dialog" aria-labelledby="myLargeModal">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            Deseja gerar um pedido com os itens pendentes neste orçamento?
                        </div>
                        <div class="modal-footer">
                            <asp:Button runat="server" ID="btnModalGerarPedido" OnClientClick="this.disabled = true; this.value = 'Gerando...';" UseSubmitBehavior="false" OnClick="btnGerarPedido_Click" CssClass=" btn btn-danger" Text="Gerar" Style="color:white"/>
                            <button type="button" class="btn btn-default" data-dismiss="modal">Cancelar</button>
                        </div>
                    </div>
                </div>
        ...
        <Triggers>
            <asp:PostBackTrigger ControlID="btnModalGerarPedido"  />
        </Triggers>
    </asp:UpdatePanel> 
     <asp:UpdatePanel ID="UpdatePanel15" runat="server" UpdateMode="Always">
        <ContentTemplate>
            <div class="modal fade" id="modalBaixarSemVenda" tabindex="-1" role="dialog" aria-labelledby="myLargeModal" >
                <div class="modal-dialog" role="document" style="height: 100%; width: 500px">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            <h4 class="modal-title" >Deseja baixar este Orçamento sem venda?</h4>
                        </div>
                        <div class="modal-body">
                            <label for="usr" style ="font-size:small">Motivo</label>
                            <asp:TextBox ID="txtModalMotivo" CssClass="form-control" runat="server"  TextMode="multiline" Columns="10" Rows="5" MaxLength="300" onFocus="this.select()" />  
                        </div>
                        <div class="modal-footer">
                            <asp:Button runat="server" ID="btnConfirmarBaixarSemVenda" OnClientClick="this.disabled = true; this.value = 'Baixando...';" UseSubmitBehavior="false" OnClick="btnConfirmarBaixaSemVenda_Click" CssClass="btn btn-danger" style="color:white" Text="Baixar" />
                            <button type="button" class="btn btn-default" data-dismiss="modal">Cancelar</button>
                        </div>
                    </div>
                </div>
        ...
        <Triggers>
            <asp:PostBackTrigger ControlID="btnConfirmarBaixarSemVenda"  />
        </Triggers>
    </asp:UpdatePanel> 
    <asp:UpdatePanel ID="UpdatePanel17" runat="server" UpdateMode="Always">
        <ContentTemplate>
            <div class="modal fade" id="modalBaixarParcial" tabindex="-1" role="dialog" aria-labelledby="myLargeModal">
                <div class="modal-dialog" role="document" style="height: 100%; width: 500px">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            <h4 class="modal-title" >Deseja baixar este Orçamento parcialmente?</h4>
                        </div>
                        <div class="modal-body">
                            <label for="usr" style ="font-size:small">Motivo</label>
                            <asp:TextBox ID="txtMotivoBaixaParcial" CssClass="form-control" runat="server" TextMode="multiline" Columns="10" Rows="5" MaxLength="300" onFocus="this.select()" />  
                        </div>
                        <div class="modal-footer">
                            <asp:Button runat="server" ID="btnConfirmarBaixarParcial" OnClientClick="this.disabled = true; this.value = 'Baixando...';" UseSubmitBehavior="false" OnClick="btnConfirmarBaixarParcial_Click" CssClass="btn btn-danger" style="color:white" Text="Baixar" />
                            <button type="button" class="btn btn-default" data-dismiss="modal">Cancelar</button>
                        </div>
                    </div>
                </div>
        ...
        <Triggers>
            <asp:PostBackTrigger ControlID="btnConfirmarBaixarParcial"  />
        </Triggers>
    </asp:UpdatePanel>
