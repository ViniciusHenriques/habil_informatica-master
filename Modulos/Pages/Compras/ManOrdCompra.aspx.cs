...
{
    public partial class ManOrdCompra : System.Web.UI.Page
    {
        ...
        List<Doc_OrdCompra> ListaOutrosOrcamentos = new List<Doc_OrdCompra>();
        ...
        protected void MontaTela(object sender, EventArgs e)
        {
                    ...
                    if (s != "³")
                    {
                        ...
                        foreach (string word in words)
                        {
                            if (word != "")
                            {
                                ...
                                doc = docDAL.PesquisarOrdemCompra(Convert.ToInt32(txtCodigo.Text));
                                if (doc == null)
                                {
            ...
            {
                ListaOutrosOrcamentos = (List<Doc_OrdCompra>)Session["ListaOutrosOrcamentos"];
        ...
        {
            Doc_OrdCompraDAL doc = new Doc_OrdCompraDAL();
        ...
        protected void btnVoltar_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("~/Pages/Compras/ConOrdCompra.aspx");
        ...
        protected void SalvarDocumento(object sender, EventArgs e)
        {
            try
            {
                ...
                Doc_OrdCompraDAL pe = new Doc_OrdCompraDAL();
                ...
                else
                {
                    ...
                    p2 = pe.PesquisarOrdemCompra(Convert.ToDecimal(txtCodigo.Text));
        ...
        protected void txtCodPessoa_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                ListaOutrosOrcamentos = docDAL.ListarOrdemCompraPessoa(codigoPessoa, CodigoDocumentoAtual);
        ...
        protected void grdAnexo_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            Response.Redirect("~/Pages/financeiros/ManAnexo.aspx?cad=11");
        }
        ...
        protected void btnAddItem_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("~/Pages/Compras/ManItemOrdCompra.aspx?cad=1");
        }
