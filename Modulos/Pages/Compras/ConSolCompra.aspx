<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPrincipal.Master" AutoEventWireup="true" CodeBehind="ConSolCompra.aspx.cs" 
    Inherits="SoftHabilInformatica.Pages.Compras.ConSolCompra"  MaintainScrollPositionOnPostback="True" %>
    ...
    <div id="divNavTeste" style="padding-left: 20px; padding-top: 20px; padding-right: 20px">
        <div class="panel panel-primary" >
            <div  class="panel-heading">
                <div>Consulta de Solicitação de Compra</div><a href="https://www.youtube.com/watch?v=alg7nQ0WG7c" target="_blank" style="float:right;margin-top:-21px"  title="Ajuda"><img src="../../Images/Help.svg" title="Ajuda"/></a>
                                           ...
                                           <div class="col-md-3" >
                                                <div class="input-group">
                                                    ...
                                                    <asp:DropDownList ID="ddlSituacao" CssClass="form-control" runat="server" Font-Size="Medium" >
                                                        ...
                                                        <asp:ListItem Value="200" Text="Aberta" Selected="True" ></asp:ListItem>
                                                        <asp:ListItem Value="201" Text="Análise"  ></asp:ListItem>
                                                        <asp:ListItem Value="202" Text="Aprovada" ></asp:ListItem>
                                                        <asp:ListItem Value="203" Text="Cancelada" ></asp:ListItem>
                                                        <asp:ListItem Value="204" Text="Cotando" ></asp:ListItem>
                                                        <asp:ListItem Value="205" Text="Encerrada" ></asp:ListItem>
                                                    </asp:DropDownList>
                                                </div>
                                            </div>
