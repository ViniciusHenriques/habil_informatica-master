<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPrincipal.Master" AutoEventWireup="true" CodeBehind="ConCotPreco.aspx.cs" 
    Inherits="SoftHabilInformatica.Pages.Compras.ConCotPreco"  MaintainScrollPositionOnPostback="True" %>
    ...
    <div id="divNavTeste" style="padding-left: 20px; padding-top: 20px; padding-right: 20px">
        <div class="panel panel-primary" >
            <div  class="panel-heading">
                <div>Consulta de Cotação de Preços</div><a href="https://www.youtube.com/watch?v=alg7nQ0WG7c" target="_blank" style="float:right;margin-top:-21px"  title="Ajuda"><img src="../../Images/Help.svg" title="Ajuda"/></a>
                                           ...
                                           <div class="col-md-3" >
                                                <div class="input-group">
                                                    ...
                                                    <asp:DropDownList ID="ddlSituacao" CssClass="form-control" runat="server" Font-Size="Medium" >
                                                        ...
                                                        <asp:ListItem Value="206" Text="Aberta" Selected="True" ></asp:ListItem>
                                                        <asp:ListItem Value="207" Text="Cancelada" ></asp:ListItem>
                                                        <asp:ListItem Value="208" Text="Encerrada" ></asp:ListItem>
                                                    </asp:DropDownList>
                                                </div>
                                            </div>
                                ...
                                <ContentTemplate>
                                    <asp:GridView ID="grdGrid" runat="server" CssClass="table table-bordered table-striped" Width="100%" 
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Cpl_Pessoa" HeaderText="Fornecedores Participantes"  ItemStyle-CssClass="padding-top-15 "/>   
                                            <asp:BoundField DataField="Cpl_DscProdutos" HeaderText="Produtos"  ItemStyle-CssClass="padding-top-15 "/>   
                                            ...
                                            <asp:BoundField DataField="Cpl_NomeUsuario" HeaderText="Nome do Comprador"  ItemStyle-CssClass="padding-top-15 "/>   
