...
{
    public partial class ManItemOrdCompra : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                if (Session["Pagina"].ToString() != Request.CurrentExecutionFilePath)
                {
                    ...
                    if (Session["Doc_OrdCompra"] != null)
                    {
                        ...
                        doc = (Doc_OrdCompra)Session["Doc_OrdCompra"];
                ...
                else
                {
                    ...
                    if (Session["Doc_OrdCompra"] == null && Request.QueryString["Cad"] == "1")
                    {
                        Response.Redirect("~/Pages/Compras/ConOrdCompra.aspx");
                    }
