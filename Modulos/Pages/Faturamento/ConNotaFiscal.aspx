<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPrincipal.Master" AutoEventWireup="true" CodeBehind="ConNotaFiscal.aspx.cs" 
    Inherits="SoftHabilInformatica.Pages.Faturamento.ConNotaFiscal"  MaintainScrollPositionOnPostback="True" %>
    ...
    <div id="divNavTeste" style="padding-left: 20px; padding-top: 20px; padding-right: 20px">
        <div class="panel panel-primary" >
            <div  class="panel-heading">
                <div>Consulta de Nota Fiscal</div><a href="https://www.youtube.com/watch?v=alg7nQ0WG7c" target="_blank" style="float:right;margin-top:-21px"  title="Ajuda"><img src="../../Images/Help.svg" title="Ajuda"/></a>
                        ...
                        <div role="tabpanel" class="tab-pane" id="aba2" style="padding-left: 20px; padding-top: 20px; padding-right: 20px; font-size: small;">
                            ...
                            <asp:GridView ID="grdGrid" runat="server" CssClass="table table-bordered table-striped" Width="100%" 
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="ValorTotalDocumento" HeaderText="Vl. Total" DataFormatString="{0:C}"/>
