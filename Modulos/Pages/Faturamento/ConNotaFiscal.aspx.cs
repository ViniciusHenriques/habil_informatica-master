...
{
    public partial class ConNotaFiscal : System.Web.UI.Page
    {
        ...
        protected void MontaFiltro(object sender, EventArgs e)
        {
            ...
            Lista = d.ListarCamposView("VW_DOC_NF");
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                if (Session["TabFocada"].ToString() == "consulta")
                    PanelSelect = "aba2";
                else
                    PanelSelect = "aba1";
            }
            ...
            {
                MontaDropDownList();
                if (Session["LST_NF"] != null)
                {
                    listaT = (List<DBTabelaCampos>)Session["LST_NF"];
            ...
            if (ListPar.Count > 0)
                if (ListPar[0].CodigoSequenciaGeracaoNFe == 147 || ListPar[0].CodigoSequenciaGeracaoNFe == 148)
                    btnNovo.Visible = false;
        }
        protected void btnConsultar_Click(object sender, EventArgs e)
        {
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_DOC_NF", lblFiltroData1.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_DOC_NF", lblFiltroData2.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_DOC_NF", lblFiltroData3.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_DOC_NF", lblFiltro1.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_DOC_NF", lblFiltro2.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_DOC_NF", lblFiltro3.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_DOC_NF", lblFiltro4.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_DOC_NF", lblFiltro5.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_DOC_NF", lblFiltro6.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_DOC_NF", lblFiltro7.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_DOC_NF", lblFiltro8.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_DOC_NF", lblFiltro9.ToolTip).ToString().ToUpper();
            ...
            Session["LST_NF"] = listaT;
            Doc_NotaFiscalDAL r = new Doc_NotaFiscalDAL();
        ...
        protected void grdGrid_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            else if (x == "Imprimir")
            {
                ...
                Response.Redirect("~/Pages/Faturamento/RelNotaFiscal.aspx");          
            }
        }
