<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPrincipal.Master" AutoEventWireup="true" CodeBehind="CadParSistema.aspx.cs" 
    ...
    <script>
        ...
        $(document).ready(function (e) {
            ...
            console.log($(item));
            $('#myTabs3 a[href="#home3"]').tab('show');
            console.log($(item));
            $('#myTabs2 a[href="#home2"]').tab('show');
            console.log($(item));
        });
                    ...
                    <div id="Tabs" role="tabpanel" style="background-color: white; border: none; text-align: left; font-size: small;">
                        ...
                        <div class="tab-content" runat="server" id="PanelContext">
                            <div role="tabpanel" class="tab-pane" id="home" style="padding-left: 20px; padding-top: 20px; padding-right: 20px; font-size: small;">
                                <!-- Nav tabs -->
                                <ul class="nav nav-tabs" role="tablist" id="myTabs3">
                                    <li role="presentation"><a href="#home3" aria-controls="home3" role="tab" data-toggle="tab"  class="tab-select"><span class="glyphicon glyphicon-wrench"></span>&nbsp;&nbsp;
                                        Estoque</a></li>
                                    <li role="presentation"><a href="#item31" aria-controls="profile" role="tab" data-toggle="tab" class="tab-select"><span class="glyphicon glyphicon-shopping-cart"></span>&nbsp;&nbsp;
                                        Compras</a></li>
		                            <li role="presentation"><a href="#item32" aria-controls="profile" role="tab" data-toggle="tab" class="tab-select"><span class="glyphicon glyphicon-shopping-cart"></span>&nbsp;&nbsp;
                                        Vendas</a></li>
                                    <li role="presentation"><a href="#item33" aria-controls="profile" role="tab" data-toggle="tab" class="tab-select"><span class="glyphicon glyphicon-calendar"></span>&nbsp;&nbsp;
                                        Compromissos</a></li>
                                </ul>
                                <!-- Tab panes -->
                                <div class="tab-content" runat="server" id="Div1">
                                    <div role="tabpanel" class="tab-pane col-md-12" id="home3" style="padding-left: 20px; padding-top: 20px; padding-right: 20px; font-size: small;">
                                        <div class="row" style="margin-top: 10px;font-size:x-small">
                                        ...
                                        <div class="row" style="margin-top: 10px;font-size:x-small">
                                            <div class="col-md-4" >
                                                <label for="usr" style ="margin-top:1px;"> Tipo Operação Ajuste de Inventario: </label>
                                                <asp:DropDownList ID="ddlAjuste" runat="server" AutoPostBack="false" CssClass="form-control js-example-basic-single" Font-Size="Small" TabIndex="2"  Width="100%"> </asp:DropDownList>
                                            </div>
                                            <div class="col-md-4" >
                                                <label for="usr" style ="margin-top:1px;"> Tipo de Listagem de Pedido: </label>
                                                <asp:DropDownList ID="ddlTpListPed" runat="server" AutoPostBack="false" CssClass="form-control js-example-basic-single" Font-Size="Small" TabIndex="2"  Width="100%"> </asp:DropDownList>
                                            </div>
                                            <div class="col-md-4" style="background-color:white;border:none;text-align:left;font-size:x-small; top:20px;">
                                                <div id="divindicadores2" style="background-color:black;border:solid 5px black; border-radius: 0px;padding-left:10px">
                                                    <asp:checkBox ID="chkConfPedido"   Text ="&emsp; Possui Conferência de Pedido" CssClass="form-control-static" runat="server" 
                                                    Enabled="true" ForeColor="White" Font-Size="Small" value="1" />&emsp;
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div role="tabpanel" class="tab-pane" id="item31" style="padding-left: 20px; padding-top: 20px; padding-right: 20px; font-size: small;">
                                                                        
                                    </div>		
		                            <div role="tabpanel" class="tab-pane" id="item32" style="padding-left: 20px; padding-top: 20px; padding-right: 20px; font-size: small;">
                                        <div class="row" style="margin-top: 10px;font-size:x-small">
                                            <div class="col-md-4" >
                                                <label for="usr" style ="margin-top:1px;">Ordem de geração de NF-e</label>
                                                <asp:DropDownList ID="ddlOrdem" runat="server"   Width="100%" CssClass="form-control js-example-basic-single" Font-Size="Small" />
                                            </div>
                                            <div class="col-md-4" style="background-color:white;border:none;text-align:left;font-size:x-small; top:20px;">
                                                <div id="divindicadores3" style="background-color:black;border:solid 5px black; border-radius: 0px;padding-left:10px">
                                                    <asp:checkBox ID="chkCrtRegras"   Text ="&emsp; Pedido Critica Regras:" CssClass="form-control-static" runat="server" 
                                                        Enabled="true" ForeColor="White" Font-Size="Small" value="1" />&emsp;
                                                    <label for="usr" style ="margin-top:1px; color: white; font-size: 12px">Comerciais, Financeiras e Fiscais</label>
                                                </div>
                                            </div>                                          
                                            <div class="col-md-4">
                                                <label for="usr">Valor do Pedido para frete minímo: </label>
                                                <asp:TextBox ID="txtValorPedido" CssClass="form-control" runat="server" Text="0,00" MaxLength="18" OnTextChanged="txtValorPedido_TextChanged" AutoPostBack="true"/>
                                            </div>                                           
                                        </div>
                                        <br />  
                                        <div class="row" style="margin-top: 10px;font-size:x-small">
                                            <div class="col-md-4">
                                                <label for="usr">Número de Dias de validade de Orçamento: </label>
                                                <asp:TextBox ID="txtDiasOrc" CssClass="form-control" runat="server" MaxLength="5" />
                                            </div> 
                                            <div class="col-md-4">
                                                <label for="usr">Frete minimo: </label>
                                                <asp:TextBox ID="txtFreteMinimo" CssClass="form-control" runat="server" Text="0,00"  MaxLength="18" OnTextChanged="txtFreteMinimo_TextChanged" AutoPostBack="true"/>
                                            </div>                                          
                                        </div>
                                    </div>
                                    <div role="tabpanel" class="tab-pane" id="item33" style="padding-left: 20px; padding-top: 20px; padding-right: 20px; font-size: small;">
                                        <asp:UpdatePanel ID="UpdatePanel8" runat="server" UpdateMode="Always">
                                             <ContentTemplate>
                                                <div class="row" style="margin-top: 10px;font-size:x-small">                                      
                                                    <div class="col-md-4">
                                                        <label for="usr">Nro Horas para alerta de compromisso: </label>
                                                        <asp:TextBox ID="txtNroHrAlerta" CssClass="form-control" runat="server" Text="1" MaxLength="5" OnTextChanged="txtNroHrAlerta_TextChanged" AutoPostBack="true"/>
                                                    </div>                                           
                                                </div>
                                            </ContentTemplate>
                                            <Triggers>
                                                <asp:AsyncPostBackTrigger  ControlID="txtNroHrAlerta" EventName="TextChanged" />
                                            </Triggers>
                                        </asp:UpdatePanel>
                                    </div>
                                </div>
                            ...
                            <div role="tabpanel" class="tab-pane" id="item2" style="padding-left: 20px; padding-top: 20px; padding-right: 20px; font-size: small;">
                                ...
                                <div id="Tabs3" role="tabpanel" style="background-color: white; border: none; text-align: left; font-size: small;">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3" style="text-align:left;font-size:x-small; padding-top:5px" >
