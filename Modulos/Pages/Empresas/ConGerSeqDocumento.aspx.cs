...
{
    public partial class ConGerSeqDocumento : System.Web.UI.Page
    {
        ...
        protected void MontaFiltro(object sender, EventArgs e)
        {
            ...
            Lista = d.ListarCamposSQL("GERADOR_SEQUENCIAL_DOCUMENTO");
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Session["LST_GERADOR_SEQUENCIAL"] != null)
            {
                listaT = (List<DBTabelaCampos>)Session["LST_GERADOR_SEQUENCIAL"];
                if (listaT.Count != 0)
            ...
            if (Session["Pagina"].ToString() != Request.CurrentExecutionFilePath)
            {
                ...
                if (Session["ZoomGeradorSequencial"] != null)
                {
        ...
        protected void btnConsultar_Click(object sender, EventArgs e)
        {
            ...
            {
                strTipo = d.ListarTipoCampoSQL("GERADOR_SEQUENCIAL_DOCUMENTO", lblFiltro1.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoSQL("GERADOR_SEQUENCIAL_DOCUMENTO", lblFiltro2.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoSQL("GERADOR_SEQUENCIAL_DOCUMENTO", lblFiltro3.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoSQL("GERADOR_SEQUENCIAL_DOCUMENTO", lblFiltro4.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoSQL("GERADOR_SEQUENCIAL_DOCUMENTO", lblFiltro5.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoSQL("GERADOR_SEQUENCIAL_DOCUMENTO", lblFiltro6.ToolTip).ToString().ToUpper();
            ...
            Session["LST_GERADOR_SEQUENCIAL"] = listaT;
            GeracaoSequencialDocumentoDAL r = new GeracaoSequencialDocumentoDAL();
            grdGrid.DataSource = r.ListarGeracaoSequencialDocumentoCompleto(listaT);
            grdGrid.DataBind();
            if (grdGrid.Rows.Count == 0)
            {
                ShowMessage("Gerador Sequencial não encontrado(s) mediante a pesquisa realizada.", MessageType.Info);
                Session["LST_GERADOR_SEQUENCIAL"] = null;
            }
        }
        protected void grdGrid_SelectedIndexChanged(object sender, EventArgs e)
        {
            Session["ZoomGeracaoSequencial"] = HttpUtility.HtmlDecode(grdGrid.SelectedRow.Cells[0].Text) + "³";
            Response.Redirect("~/Pages/Empresas/CadGerSeqDocumento.aspx");
        }
        protected void btnNovo_Click(object sender, EventArgs e)
        {

            TipoDocumentoDAL r = new TipoDocumentoDAL();
            if (r.ListarTipoDocumento("", "", "", "").Count == 0)
            { 
                ShowMessage("Nenhum Tipo(s) de Documento Liberado para Geração.", MessageType.Info);
            }
