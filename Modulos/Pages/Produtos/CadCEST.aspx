<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPrincipal.Master" AutoEventWireup="true" CodeBehind="CadCEST.aspx.cs" Inherits="SoftHabilInformatica.Pages.Produtos.CadCEST" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cttCorpo" runat="server">
    ...
    <div id="divNavTeste" style="padding-left:20px;padding-top:20px;padding-right:20px" >
            ...
            <div  class="panel panel-primary" >
                <div class="panel-heading">Cadastro de CESTs
                ...
                <div class="panel-body">
                    ...
                    <br />
                    <div class="input-group">
                        <span class="input-group-addon">Código da CEST : &nbsp;&nbsp;&nbsp; </span>
                    ...
                    <br />
                    <div class="input-group">
                        <span class="input-group-addon">Código do NCM : </span>
                        <asp:TextBox ID="txtNCM"  CssClass="form-control" name="txtNCM" TabIndex="3" runat="server"  MaxLength="100" />
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon">Descrição da CEST : </span>

                        <asp:TextBox ID="txtDescricao"  CssClass="form-control" name="txtDescricao" TabIndex="4" runat="server"  MaxLength="500" Height="100" TextMode="MultiLine" />
                    </div>
