...
{
    public partial class ConMarca : System.Web.UI.Page
    {
        ...
        protected void btnConsultar_Click(object sender, EventArgs e)
        {
            ...
            {
                strTipo = d.ListarTipoCampoSQL("MARCA", lblFiltro1.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoSQL("MARCA", lblFiltro2.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoSQL("MARCA", lblFiltro3.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoSQL("MARCA", lblFiltro4.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoSQL("MARCA", lblFiltro5.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoSQL("MARCA", lblFiltro6.ToolTip).ToString().ToUpper();
            ...
            grdGrid.DataSource = r.ListarMarcaCompleto(lista);

            grdGrid.DataBind();
            if (grdGrid.Rows.Count == 0)
                ShowMessage("Marca(s) não encontrado(s) mediante a pesquisa realizada.", MessageType.Info);

        }
        protected void grdGrid_SelectedIndexChanged(object sender, EventArgs e)
        {
            Session["ZoomMarca"] = HttpUtility.HtmlDecode(grdGrid.SelectedRow.Cells[0].Text) + "³";
