<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPrincipal.Master" AutoEventWireup="true" CodeBehind="CadUnidade.aspx.cs" Inherits="SoftHabilInformatica.Pages.Produtos.CadUnidade" %>
    ...
    <div id="divNavTeste" style="padding-left:20px;padding-top:20px;padding-right:20px" >
        ...
        <ContentTemplate>
            ...
            <div  class="panel panel-primary" >
                <div class="panel-heading">Cadastro de Unidades
                ...
                <div class="panel-body">
                   ...
                   <br/><br/><br/>
                    <div class="input-group">
                        <span class="input-group-addon">Código do Unidade : &nbsp;&nbsp;&nbsp; </span>
                    ...
                    <br />
                    <div class="input-group">
                        <span class="input-group-addon">Descrição do Unidade : </span>
                        <asp:TextBox ID="txtDescricao"  CssClass="form-control" name="txtDescricao" TabIndex="2" runat="server" Width="1000" MaxLength="50" />
                    </div>
                    <br />
                    <br />
                    <div class="input-group">
                        <span class="input-group-addon">Sigla da Unidade : </span>
                        <asp:TextBox ID="txtSigla"  CssClass="form-control" name="txtSigla" TabIndex="2" runat="server" Width="100" MaxLength="3" />
                    </div>
                </div>
            </div>
            </ContentTemplate>
