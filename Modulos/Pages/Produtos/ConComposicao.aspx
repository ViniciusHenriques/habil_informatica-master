<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPrincipal.Master" AutoEventWireup="true" CodeBehind="ConComposicao.aspx.cs" Inherits="SoftHabilInformatica.Pages.Produtos.ConComposicao" %>
...
$(document).ready(function (e) {
    ...
    <div id="divNavTeste" style="padding-left:20px;padding-top:20px;padding-right:20px" >
        ...
        <div class="panel panel-primary" >
            <div  class="panel-heading">Consulta de Composição
                ...
                <div id="Tabs" role="tabpanel" >
                    ...
                    <div class="tab-content" runat="server" id="PanelContext">
                        ...
                        <div role="tabpanel" class="tab-pane" id="consulta" style="padding-left:20px;padding-top:20px;padding-right:20px;font-size:small;"   >
                            ...
                            <asp:LinkButton ID="btnImprimir" visible="false" runat="server" Text="Nova Consulta" CssClass="btn btn-success" OnClick="btnImprimir_Click"> 
                            ...
                            <asp:GridView ID="grdGrid" runat="server" Width="100%" 
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Data" HeaderText="Descrição" />
                                    <asp:BoundField DataField="ValorCustoProduto" HeaderText="Descrição" />
