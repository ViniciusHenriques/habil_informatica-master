...
{
    public partial class ConFabricante : System.Web.UI.Page
    {
        ...
        protected void MontaFiltro(object sender, EventArgs e)
        {
            ...
            Lista = d.ListarCamposSQL("FABRICANTE");
            ...
            foreach (DBTabela Lst in Lista)
            {
                if (shtI == 1)
                {
                    ...
                    txtFiltro11.Text = "";
                    txtFiltro12.Text = "";
                    txtFiltro11.MaxLength = Convert.ToInt16(Lst.Tamanho);
                    txtFiltro12.MaxLength = Convert.ToInt16(Lst.Tamanho);
                }
                if (shtI == 2)
                {
                    ...
                    txtFiltro21.Text = "";
                    txtFiltro22.Text = "";
                    txtFiltro21.MaxLength = Convert.ToInt16(Lst.Tamanho);
                    txtFiltro22.MaxLength = Convert.ToInt16(Lst.Tamanho);
                }
                if (shtI == 3)
                {
                    ...
                    txtFiltro31.Text = "";
                    txtFiltro32.Text = "";
                    txtFiltro31.MaxLength = Convert.ToInt16(Lst.Tamanho);
                    txtFiltro32.MaxLength = Convert.ToInt16(Lst.Tamanho);
                }
                if (shtI == 4)
                {
                    ...
                    txtFiltro41.Text = "";
                    txtFiltro42.Text = "";
                    txtFiltro41.MaxLength = Convert.ToInt16(Lst.Tamanho);
                    txtFiltro42.MaxLength = Convert.ToInt16(Lst.Tamanho);
                }
                if (shtI == 5)
                {
                    ...
                    txtFiltro51.Text = "";
                    txtFiltro52.Text = "";
                    txtFiltro51.MaxLength = Convert.ToInt16(Lst.Tamanho);
                    txtFiltro52.MaxLength = Convert.ToInt16(Lst.Tamanho);
                }
                if (shtI == 6)
                {
                    ...
                    txtFiltro61.Text = "";
                    txtFiltro62.Text = "";
                    txtFiltro61.MaxLength = Convert.ToInt16(Lst.Tamanho);
                    txtFiltro62.MaxLength = Convert.ToInt16(Lst.Tamanho);
                }
                shtI++;
            }
        }
        ...
        protected void btnConsultar_Click(object sender, EventArgs e)
        {
            ...
            {
                strTipo = d.ListarTipoCampoSQL("FABRICANTE", lblFiltro1.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoSQL("FABRICANTE", lblFiltro2.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoSQL("FABRICANTE", lblFiltro3.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoSQL("FABRICANTE", lblFiltro4.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoSQL("FABRICANTE", lblFiltro5.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoSQL("FABRICANTE", lblFiltro6.ToolTip).ToString().ToUpper();
            ...
            grdGrid.DataSource = r.ListarFabricanteCompleto(lista);

            grdGrid.DataBind();
            if (grdGrid.Rows.Count == 0)
                ShowMessage("Fabricante(s) não encontrado(s) mediante a pesquisa realizada.", MessageType.Info);

        }
        protected void grdGrid_SelectedIndexChanged(object sender, EventArgs e)
        {
            Session["ZoomFabricante"] = HttpUtility.HtmlDecode(grdGrid.SelectedRow.Cells[0].Text) + "³";
