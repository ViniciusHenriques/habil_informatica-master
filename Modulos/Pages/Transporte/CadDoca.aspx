<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPrincipal.Master" AutoEventWireup="true" CodeBehind="CadDoca.aspx.cs" Inherits="SoftHabilInformatica.Pages.Transporte.CadDoca" %>
    ...
    <div id="divNavTeste" style="padding-left:20px;padding-top:20px;padding-right:20px" >
        ...
        <ContentTemplate>
            ...
            <div  class="panel panel-primary" >
                <div class="panel-heading">Cadastro de Docas
                   ...
                   <br/><br/>
                    <div class="col-md-4">
                        <div class="input-group ">
                            <span class="input-group-addon">Código da Doca : &nbsp;&nbsp;&nbsp; </span>
                  ...
                  <div class="col-md-5">
                      <div class="input-group " style="background-color:white;border:none;text-align:left;font-size:x-small;">
                            <div class="input-group">
                                ...
                                <asp:DropDownList ID="ddlEmpresa" runat="server" AutoPostBack="true"  CssClass="form-control js-example-basic-single" Font-Size="Small"> </asp:DropDownList>
                           </div>
                    ...
                    <div class="col-md-12">
                        <div class="input-group">
                            <span class="input-group-addon">Descrição da Doca : </span>
