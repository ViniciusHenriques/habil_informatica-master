<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPrincipal.Master" AutoEventWireup="true" CodeBehind="ConRegFrete.aspx.cs" Inherits="SoftHabilInformatica.Pages.Transporte.ConRegFrete" %>
   ...
   <link type="text/css" href="../../Content/Style.css" rel="stylesheet" />
    ...
    <div id="divNavTeste" style="padding-left:20px;padding-top:20px;padding-right:20px" >
        <div class="panel panel-primary" >
            <div  class="panel-heading">Consulta de regra de frete
            ...
            <div class="panel-body">
                ...
                <asp:GridView ID="grdGrid" runat="server" Width="100%" 
                    ...
                    <Columns>
                        <asp:BoundField DataField="CodigoIndex" HeaderText="Código" />
                        <asp:BoundField DataField="Regiao" HeaderText="Região" />
                        <asp:BoundField DataField="CodigoTransportador" HeaderText="Código Transportador" />
                        <asp:BoundField DataField="Cpl_NomeTransportador" HeaderText="Transportador" />
                        <asp:BoundField DataField="Cpl_InscricaoTransportador" HeaderText="CNPJ" />
                        <asp:BoundField DataField="ValorFreteMinimo" HeaderText="Frete Minimo" />
                        <asp:BoundField DataField="ValorGRIS" HeaderText="GRIS" />

                        <asp:CommandField HeaderText="Acessar" ShowSelectButton="True" 
