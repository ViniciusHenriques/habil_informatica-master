<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPrincipal.Master" AutoEventWireup="true" CodeBehind="ConCTe.aspx.cs" 
    Inherits="SoftHabilInformatica.Pages.Transporte.ConCTe"  MaintainScrollPositionOnPostback="True" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cttCorpo" runat="server">
    ...
    <div id="divNavTeste" style="padding-left: 20px; padding-top: 20px; padding-right: 20px">
        <div class="panel panel-primary ">
            <div  class="panel-heading panel-heading-padrao" >Consulta de CT-e
                                           ...
                                           <div class="col-md-3" >
                                                <div class="input-group">
                                                    ...
                                                    <asp:DropDownList ID="ddlSituacao" CssClass="form-control" runat="server" Font-Size="Medium" >                                                         
                                                        ...
                                                        <asp:ListItem Value="3" Text="Rejeitado"></asp:ListItem>
                        ...
                        <div role="tabpanel" class="tab-pane" id="consulta" style="padding-left: 20px; padding-top: 20px; padding-right: 20px; font-size: small;">
                            ...
                            <asp:GridView ID="grdGrid" runat="server" CssClass="table table-bordered table-striped " Width="100%" 
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="NumeroDocumento" HeaderText="Doc" />
                                    <asp:BoundField DataField="DataHoraEmissao" HeaderText="Data/Hora Emissão"/>
                                    <asp:BoundField DataField="Cpl_Transportador" HeaderText="Transportador" />   
                                    <asp:BoundField DataField="Cpl_Remetente" HeaderText="Remetente" ItemStyle-CssClass="noprint " HeaderStyle-CssClass="noprint" />   
                                    <asp:BoundField DataField="Cpl_Destinatario" HeaderText="Destinatário" ItemStyle-CssClass="noprint " HeaderStyle-CssClass="noprint" />   
                                    <asp:TemplateField HeaderText="Situação" ItemStyle-CssClass="centerVertical ">
                                        <ItemTemplate>
                                            <label  class="badge <%# Eval("Cpl_DsSituacao").ToString().Replace("(A)","") %>" id="situacaoSpan" ><%# Eval("Cpl_DsSituacao").ToString() %></label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
