...
{
    public partial class ConRegFisIPI : System.Web.UI.Page
    {
        ...
        protected void MontaFiltro(object sender, EventArgs e)
        {
            ...
            Lista = d.ListarCamposSQL("REGRA_FISCAL_IPI");
        ...
        protected void btnConsultar_Click(object sender, EventArgs e)
        {
            ...
            {
                strTipo = d.ListarTipoCampoSQL("REGRA_FISCAL_IPI", lblFiltro1.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoSQL("REGRA_FISCAL_IPI", lblFiltro2.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoSQL("REGRA_FISCAL_IPI", lblFiltro3.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoSQL("REGRA_FISCAL_IPI", lblFiltro4.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoSQL("REGRA_FISCAL_IPI", lblFiltro5.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoSQL("REGRA_FISCAL_IPI", lblFiltro6.ToolTip).ToString().ToUpper();
            ...
            grdGrid.DataSource = r.ListarRegrasIPI(lista);
            grdGrid.DataBind();
            Session["ZoomRelRegraIPI2"] = lista;
            if (grdGrid.Rows.Count == 0)
                ShowMessage("Regra(s) de IPI não encontrada(a) mediante a pesquisa realizada.",MessageType.Info);

        }
        protected void grdGrid_SelectedIndexChanged(object sender, EventArgs e)
        {
            Session["ZoomRegraIPI"] = HttpUtility.HtmlDecode(grdGrid.SelectedRow.Cells[0].Text) + "³";
            Response.Redirect("~/Pages/Impostos/ManRegFisIPI.aspx");
        }
        ...
        {
            Session["ZoomRelRegraIPI"] = Session["ZoomRelRegraIPI2"];
            Session["ZoomRelRegraIPI2"] = null;
            Response.Redirect("~/Pages/Impostos/RelRegFisIPI.aspx");
        }
    }
}