<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPrincipal.Master" AutoEventWireup="true" CodeBehind="ConRegFisIPI.aspx.cs" Inherits="SoftHabilInformatica.Pages.Impostos.ConRegFisIPI" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cttCorpo" runat="server">
    ...
    <style> 
        .larguraMinima{min-width:1px;} 
    </style>
    <div id="divNavTeste" style="padding-left:20px;padding-top:20px;padding-right:20px" >
        <div class="panel panel-primary" >
            <div  class="panel-heading"> Consulta Refra Fiscal IPI
                ...
                <div id="Tabs" role="tabpanel" >
                    ...
                    <div class="tab-content" runat="server" id="PanelContext">
                        ...
                        <div role="tabpanel" class="tab-pane" id="consulta" style="padding-left:20px;padding-top:20px;padding-right:20px;font-size:small;"   >
                            ...
                            <br/>
                            <br/>
                            <div class="panel-body" style="overflow-x:scroll;height:415px">
                                ...
                                <Columns>
                                    <asp:BoundField DataField="CodigoRegraFiscalIPI" HeaderText="Regra Fiscal IPI" />
                                    <asp:BoundField DataField="DtVigencia" HeaderText="Dt. Vigência" />
                                    <asp:BoundField DataField="CodigoSituacaoTributaria" HeaderText="Cód. Trib. Situação" />
                                    <asp:BoundField DataField="CodigoNCM" HeaderText="Código NCM" />
                                    <asp:BoundField DataField="DescricaoNCM" HeaderStyle-CssClass="larguraMinima" HeaderText="Descrição NCM" />
                                    <asp:BoundField DataField="CodigoEx" HeaderText="Codigo Ex" />
