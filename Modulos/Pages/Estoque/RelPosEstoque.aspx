<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPrincipal.Master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeBehind="RelPosEstoque.aspx.cs" Inherits="SoftHabilInformatica.Pages.Estoque.RelPosEstoque" %>
...
<%@ Register Assembly="CrystalDecisions.Web, Version=13.0.3500.0, Culture=neutral, PublicKeyToken=692fbea5521e1304" Namespace="CrystalDecisions.Web" TagPrefix="CR" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $("input[id*='txtDtRef']").datepicker({ todayBtn: "linked", clearBtn: true, format: "dd/mm/yyyy", autoclose: "false", language: "pt-BR", locate: "pt-BR" });
                        ...
                        <asp:UpdatePanel ID="InsertEmployeeUpdatePanel" runat="server" onFocus="this.select()" UpdateMode="Always">
                            <ContentTemplate>
                                <div class="row" style="margin-top: 10px">
                                    ...
                                    <div class="col-md-2">
                                        <label for="usr">Dt Referência: </label>
                                        <asp:TextBox ID="txtDtRef" CssClass="form-control" Enabled="true" runat="server" TabIndex="2"/>
                                    </div>                                  
                                    ...
                                    <div class="col-md-6">
                                            ...
                                            <ContentTemplate>
                                                <label for="usr"> Até: </label>
                                                    <asp:DropDownList ID="ddlLocalizacao2" runat="server" AutoPostBack="true" Width="100%" CssClass="form-control js-example-basic-single" Font-Size="Small" TabIndex="7"> </asp:DropDownList>		   
                                            </ContentTemplate> 
                                            <Triggers> 
