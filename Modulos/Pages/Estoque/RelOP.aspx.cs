...
{
    public partial class RelOP: System.Web.UI.Page
    {
        ...
        private void MontaCrystal()
        {
			...
			RptDoc.Load(Server.MapPath("~/Pages/Estoque/RPT/RelOP.rpt"));
			...
			if(Session["Codigo_OP"] != null)
				RptDoc.SetDataSource(RnDAL.RelOP(Convert.ToDecimal(Session["Codigo_OP"].ToString())));
