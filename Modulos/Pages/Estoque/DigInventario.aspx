<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPrincipal.Master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeBehind="DigInventario.aspx.cs" Inherits="SoftHabilInformatica.Pages.Estoque.DigInventario" %>
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            <asp:Panel id="pnlRel" runat="server" Visible="false">
                ...
                <div class="col-md-3">
                    <asp:DropDownList ID="ddlContagem" CssClass="form-control" OnSelectedIndexChanged="ddlContagem_SelectedIndexChanged" AutoPostBack="true"  runat="server" TabIndex="11" Font-Size="Medium" ></asp:DropDownList>
                </div>
                                ...
                                PagerSettings-Mode="NumericFirstLast" >
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Quantidade" >
                                            <ItemTemplate>                                                 
                                                        <asp:TextBox ID="txtQtMov1" AutoPostBack="false" runat="server" CssClass="form-control" Text='<%# Eval("QtContagem").ToString() %>'/>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Zerar Qtd." >
                                            <ItemTemplate>                                                 
                                                <asp:CheckBox runat="server"  id="chkZerar" AutoPostBack="false"/>
                                            </ItemTemplate>
                                        </asp:TemplateField>
