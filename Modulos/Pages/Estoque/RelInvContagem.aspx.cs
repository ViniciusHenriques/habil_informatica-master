...
{ 
    public partial class RelInvContagem : System.Web.UI.Page
    {        
        ...
        {
            Session["ZoomRelParaInv"] = HttpUtility.HtmlDecode(grdGrid.SelectedRow.Cells[1].Text);
        ...
        protected void MontarDescricaoInventario()
        {
            string dtlancamento = "";
            string desc = "";
            decimal indice = Convert.ToInt32(Session["ZoomRelParaInv"].ToString());
        ...
        private void MontaCrystal()
        {
            ...
            if (Session["ZoomRelParaInv"] == null)
            {
                Session["ZoomRelParaInv"] = 0;
            }
            MontarDescricaoInventario();

            RptDoc.Load(Server.MapPath("~/Pages/Estoque/RPT/RelParaInventario.rpt"));                        
            ...
            if (ddlContagem.Text != "Selecione a Contagem")
            {
                RptDoc.DataDefinition.FormulaFields["Contagem"].Text = "'" + ddlContagem.Text + "ª Contagem'";
            ...
            RptDoc.SetDataSource(RnInventarioDAL.RelParaInventario(Convert.ToInt32(Session["ZoomRelParaInv"].ToString())));
        ...
        protected void btnVoltar_Click(object sender, EventArgs e)
        {
            ...
            ddlContagem.Visible = false;
            Session["ZoomRelParaInv"] = 0;
            ddlContagem.Text = "Selecione a Contagem";
            MontaCrystal();
        }
        protected void MontaDll(object sender, EventArgs e)
        {
            ddlContagem.Items.Clear();
            ddlContagem.Items.Insert(0, "Selecione a Contagem");
