<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPrincipal.Master" AutoEventWireup="true" CodeBehind="ConOrdProducao.aspx.cs" 
    Inherits="SoftHabilInformatica.Pages.Estoque.ConOrdProducao"  MaintainScrollPositionOnPostback="True" %>
    ...
    <div id="divNavTeste" style="padding-left: 20px; padding-top: 20px; padding-right: 20px">
        <div class="panel panel-primary" >
            <div  class="panel-heading">
                <div>Consulta de Ordem de Produção</div><a href="https://www.youtube.com/watch?v=alg7nQ0WG7c" target="_blank" style="float:right;margin-top:-21px"  title="Ajuda"><img src="../../Images/Help.svg" title="Ajuda"/></a>
                                           ...
                                           <div class="col-md-3" >
                                                <div class="input-group">
                                                    ...
                                                    <asp:DropDownList ID="ddlSituacao" CssClass="form-control" runat="server" Font-Size="Medium" >
                                                        ...
                                                        <asp:ListItem Value="136" Text="Aberto"  ></asp:ListItem>
                                                        <asp:ListItem Value="137" Text="Cancelado"></asp:ListItem>
                                                        <asp:ListItem Value="137" Text="Produção"></asp:ListItem>
                                                        <asp:ListItem Value="138" Text="Encerrado"></asp:ListItem>
                                                    </asp:DropDownList>
                                                </div>
                                            </div>
                                ...
                                <ContentTemplate>
                                    <asp:GridView ID="grdGrid" runat="server" CssClass="table table-bordered table-striped" Width="100%" 
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="CodigoComposto" HeaderText="Composto"  ItemStyle-CssClass="padding-top-15 "/>   
                                            <asp:BoundField DataField="Cpl_NomeProduto" HeaderText="Descrição"  ItemStyle-CssClass="padding-top-15 "/>   
