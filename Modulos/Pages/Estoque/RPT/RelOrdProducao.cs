...
namespace HabilInformatica.Pages.Estoque.RPT {
    ...
    public class RelOrdProducao : ReportClass {
        
        public RelOrdProducao() {
        }
        
        public override string ResourceName {
            get {
                return "RelOrdProducao.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "HabilInformatica.Pages.Estoque.RPT.RelOrdProducao.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRelOrdProducao : Component, ICachedReport {
        
        public CachedRelOrdProducao() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RelOrdProducao rpt = new RelOrdProducao();
            rpt.Site = this.Site;
            return rpt;
        }
