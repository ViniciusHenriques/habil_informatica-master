<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPrincipal.Master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeBehind="CanInventario.aspx.cs" Inherits="SoftHabilInformatica.Pages.Estoque.CanInventario" %>
...
<div id="divNavTeste" style="padding-left: 20px; padding-top: 20px; padding-right: 20px; font-size: small;">
                            ...
                            <asp:GridView ID="grdGrid" runat="server" Width="100%" GridView="800" 
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Ação" >
                                        <ItemTemplate>
                                                <asp:LinkButton ID="btnCancelar" runat="server" CssClass="btn btn-link buttonGrid" CommandName="CancelarInventario" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" Visible='<%# Eval("BtnCancelar") %>' title="Cancelar" >
    ...
    <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
        ...
        <Triggers>
            <asp:PostBackTrigger  ControlID="btnSimCancelar" />
