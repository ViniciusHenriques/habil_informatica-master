...
{
    public partial class ConOrdProducao: System.Web.UI.Page
    {
        ...
        protected void MontaDropDownList()
        {
            ...
            ddlAplicacaoUso.DataSource = sd.SituacaoAplicaUsoOrdemProducao();
        ...
        protected void MontaFiltro(object sender, EventArgs e)
        {
            ...
            Lista = d.ListarCamposView("VW_DOC_ORD_PRODUCAO");
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                MontaDropDownList();
                if (Session["LST_ORD_PROD"] != null)
                {
                    listaT = (List<DBTabelaCampos>)Session["LST_ORD_PROD"];
        ...
        protected void btnConsultar_Click(object sender, EventArgs e)
        {
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_DOC_ORD_PRODUCAO", lblFiltroData1.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_DOC_ORD_PRODUCAO", lblFiltroData2.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_DOC_ORD_PRODUCAO", lblFiltroData3.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_DOC_ORD_PRODUCAO", lblFiltro1.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_DOC_ORD_PRODUCAO", lblFiltro2.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_DOC_ORD_PRODUCAO", lblFiltro3.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_DOC_ORD_PRODUCAO", lblFiltro4.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_DOC_ORD_PRODUCAO", lblFiltro5.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_DOC_ORD_PRODUCAO", lblFiltro6.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_DOC_ORD_PRODUCAO", lblFiltro7.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_DOC_ORD_PRODUCAO", lblFiltro8.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_DOC_ORD_PRODUCAO", lblFiltro9.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_DOC_ORD_PRODUCAO", lblFiltro10.ToolTip).ToString().ToUpper();
            ...
            Session["LST_ORD_PROD"] = listaT;

            listaT = listaT.Where((x => x.Filtro == "CD_SITUACAO" && x.Inicio != "0" || x.Filtro != "CD_SITUACAO")).ToList();

            Doc_OrdProducaoDAL r = new Doc_OrdProducaoDAL();
            grdGrid.DataSource = r.ListarOrdemProducaoaoCompleto(listaT);
            grdGrid.DataBind();
        ...
        protected void grdGrid_SelectedIndexChanged(object sender, GridViewCommandEventArgs e)
        {
            ...
            Session["ZoomOrdProducao"] = Codigo + "³";
