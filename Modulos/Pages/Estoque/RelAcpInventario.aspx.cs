...
{
    public partial class RelAcpInventario : System.Web.UI.Page
    {
        ...
        private void MontaCrystal()
        {
            ...
            RptDoc.Load(Server.MapPath("~/Pages/Estoque/RPT/RelAcpInventario.rpt"));
            ...
            RptDoc.SetDataSource(RnInventarioDAL.RelAcompanhamentoInventario(Convert.ToInt32(Session["ZoomRelInv"].ToString())));
