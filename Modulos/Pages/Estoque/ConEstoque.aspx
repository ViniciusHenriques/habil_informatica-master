<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPrincipal.Master" AutoEventWireup="true" CodeBehind="ConEstoque.aspx.cs" Inherits="SoftHabilInformatica.Pages.Estoque.ConEstoque" %>
            ...
            <div class="panel-body">
                ...
                <asp:GridView ID="grdGrid" runat="server" Width="100%"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="CodigoLocalizacao" HeaderText="Localização" />
                        <asp:BoundField DataField="CodigoLote" HeaderText="Lote" />
