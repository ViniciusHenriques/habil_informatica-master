...
{
    public partial class ConEmbRetornavel : System.Web.UI.Page
    {
        ...
        protected void MontaFiltro(object sender, EventArgs e)
        {
            ...
            Lista = d.ListarCamposSQL("EMBALAGEM_RETORNAVEL");
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Session["Pagina"].ToString() != Request.CurrentExecutionFilePath)
            {
                ...
                if (Session["ZoomEmbalagem2"] != null)
                {
        ...
        protected void btnConsultar_Click(object sender, EventArgs e)
        {
            ...
            {
                strTipo = d.ListarTipoCampoSQL("EMBALAGEM_RETORNAVEL", lblFiltro1.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoSQL("EMBALAGEM_RETORNAVEL", lblFiltro2.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoSQL("EMBALAGEM_RETORNAVEL", lblFiltro3.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoSQL("EMBALAGEM_RETORNAVEL", lblFiltro4.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoSQL("EMBALAGEM_RETORNAVEL", lblFiltro5.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoSQL("EMBALAGEM_RETORNAVEL", lblFiltro6.ToolTip).ToString().ToUpper();
            ...
            EmbalagemRetornavelDAL r = new EmbalagemRetornavelDAL();
            grdGrid.DataSource = r.ListarEmbalagens(lista);
            grdGrid.DataBind();
            if (grdGrid.Rows.Count == 0)
                ShowMessage("Embalagem(s) não encontrado(s) mediante a pesquisa realizada.",MessageType.Info);

        }
        protected void grdGrid_SelectedIndexChanged(object sender, EventArgs e)
        {
            Session["ZoomEmbalagemRetornavel"] = HttpUtility.HtmlDecode(grdGrid.SelectedRow.Cells[0].Text) + "³";
            Response.Redirect("~/Pages/Estoque/CadEmbRetornavel.aspx");
        }
