<%@ Page Title="" Language="C#" MasterPageFile="~/MasterRelacional.Master" AutoEventWireup="true" 
    CodeBehind="CadPesFinanceiro.aspx.cs" Inherits="SoftHabilInformatica.Pages.Pessoas.CadPesFinanceiro" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cttCorpo" runat="server">
    ...
    <div id="divNavTeste" style="padding-left:20px;padding-top:20px;padding-right:20px;font-size:small;" >
        ...
        <div class="panel panel-primary">
            <div class="panel-heading">Cadastro Financeiro de Pessoa
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-md-6" style="font-size:x-small;margin-top:3px;padding-right:20px;padding-left:20px">
                        <label for="usr" style ="margin-top:1px;">Condição de Pagamento</label>
                        <asp:DropDownList ID="ddlCondPagamento" runat="server" TabIndex="1"  Width="100%" CssClass="form-control js-example-basic-single" Font-Size="Small"/>
                    </div>
                    <div class="col-md-6" style="font-size:x-small;margin-top:3px;padding-right:20px;padding-left:20px">
                        <label for="usr" style ="margin-top:1px;">Plano de Contas</label>
                        <asp:DropDownList ID="ddlPlanoConta" runat="server" AutoPostBack="False" Width="100%" TabIndex="2" CssClass="form-control js-example-basic-single" Font-Size="Small" />
                    </div>
                    <div class="col-md-6" style="font-size:x-small;margin-top:3px;padding-right:20px;padding-left:20px">
                        <label for="usr" style ="margin-top:1px;">Tipo de Serviço</label>
                        <asp:DropDownList ID="ddlTipoServico" runat="server" AutoPostBack="False" Width="100%" TabIndex="3" CssClass="form-control js-example-basic-single" Font-Size="Small" />
                    </div>
                    <div class="col-md-6" style="font-size:x-small;margin-top:3px;padding-right:20px;padding-left:20px">
                        <label for="usr" style ="margin-top:1px;">Tipo de Cobrança</label>
                        <asp:DropDownList ID="ddlTipoCobranca" runat="server" AutoPostBack="False" Width="100%" TabIndex="3" CssClass="form-control js-example-basic-single" Font-Size="Small" />
                    </div>
                    <asp:UpdatePanel ID="UpdatePanel6" runat="server" UpdateMode="Always">
                        <ContentTemplate>
                            <div class="col-md-6" style="font-size:x-small;margin-top:3px;padding-right:20px;padding-left:20px" >
                                <label for="usr">Limite de Crédito</label>
                                <asp:TextBox ID="txtLimiteCredito" Text="0,00" CssClass="form-control" TabIndex="4" runat="server" MaxLength="18" AutoPostBack="true" OnTextChanged="txtCreditoCompra_TextChanged" onFocus="this.select()"/>
                            </div>
                        </ContentTemplate> 
                        <Triggers>
                            <asp:AsyncPostBackTrigger ControlID="txtLimiteCredito" EventName="TextChanged" />
                        </Triggers>
                    </asp:UpdatePanel>
                </div>
            </div>
