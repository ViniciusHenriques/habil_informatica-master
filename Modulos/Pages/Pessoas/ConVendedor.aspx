<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPrincipal.Master" AutoEventWireup="true" CodeBehind="ConVendedor.aspx.cs" Inherits="SoftHabilInformatica.Pages.Pessoas.ConVendedor" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cttCorpo" runat="server">
    ...
    <div id="divNavTeste" style="padding-left:20px;padding-top:20px;padding-right:20px" >
        <div class="panel panel-primary" >
            <div  class="panel-heading">Consulta de Vendedores
            ...
            <div class="panel-body">
                ...
                <asp:GridView ID="grdGrid" runat="server" Width="100%" 
                    ...
                    <Columns>
                        <asp:BoundField DataField="CodigoVendedor" HeaderText="Código" />
                        <asp:BoundField DataField="Pessoa.NomePessoa" HeaderText="Nome do Vendedor" />
