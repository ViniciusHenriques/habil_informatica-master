...
{
    public partial class ConGpoPessoa : System.Web.UI.Page
    {
        ...
        protected void MontaFiltro(object sender, EventArgs e)
        {
            ...
            Lista = d.ListarCamposSQL("GRUPO_DE_PESSOA");
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Session["LST_GRUPOPESSOA"] != null)
            {
                listaT = (List<DBTabelaCampos>)Session["LST_GRUPOPESSOA"];
                if (listaT.Count != 0)
        ...
        protected void btnConsultar_Click(object sender, EventArgs e)
        {
            ...
            {
                strTipo = d.ListarTipoCampoSQL("GRUPO_DE_PESSOA", lblFiltro1.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoSQL("GRUPO_DE_PESSOA", lblFiltro2.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoSQL("GRUPO_DE_PESSOA", lblFiltro3.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoSQL("GRUPO_DE_PESSOA", lblFiltro4.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoSQL("GRUPO_DE_PESSOA", lblFiltro5.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoSQL("GRUPO_DE_PESSOA", lblFiltro6.ToolTip).ToString().ToUpper();
            ...
            Session["LST_GRUPOPESSOA"] = listaT;
            GrupoPessoaDAL r = new GrupoPessoaDAL();
            grdGrid.DataSource = r.ListarGrupoPessoaCompleto(listaT);
            grdGrid.DataBind();
            if (grdGrid.Rows.Count == 0)
            {
                ShowMessage("Grupo(s) de Pessoa(s) não encontrado(s) mediante a pesquisa realizada.", MessageType.Info);
                Session["LST_GRUPOPESSOA"] = null;
            }
        }
        protected void grdGrid_SelectedIndexChanged(object sender, EventArgs e)
        {
            Session["ZoomGrupoPessoa"] = HttpUtility.HtmlDecode(grdGrid.SelectedRow.Cells[0].Text) + "³";
