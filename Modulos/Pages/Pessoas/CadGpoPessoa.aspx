<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPrincipal.Master" AutoEventWireup="true" CodeBehind="CadGpoPessoa.aspx.cs" Inherits="SoftHabilInformatica.Pages.Pessoas.CadGpoPessoa" %>
    ...
    <div id="divNavTeste" style="padding-left:20px;padding-top:20px;padding-right:20px" >
        ...
        <ContentTemplate>
            ...
            <div  class="panel panel-primary" >
                <div class="panel-heading">Cadastro de Grupo de Pessoa
                   ...
                   <br/><br/>
                    ...
                    <div class="row" style="background-color:white;border:none;">
                        ...
                        <div class="col-md-2" style="background-color:white;border:none;text-align:left;font-size:x-small;">
                            <div class="input-group">
                                <span class="input-group-addon">Gerar Matrícula : </span>
                                <asp:CheckBox ID="chkGerarMatricula" CssClass="form-control" runat="server"  />
                            </div>
                        </div>
                    </div>
      ...
      <div class="modal-dialog" role="document" style ="height:100%;width:300px">
        <div class="modal-content" >
          ...
          <div class="modal-body">
              Deseja Excluir este Grupo de Pessoa ?
          </div>
