<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPrincipal.Master" AutoEventWireup="true" CodeBehind="ConPessoa.aspx.cs" Inherits="SoftHabilInformatica.Pages.Pessoas.ConPessoa" %>
...
<%--    <link type="text/css" href="~/Content/Style.css" rel="stylesheet" />
    ...
    <div id="divNavTeste" style="padding-left: 20px; padding-top: 20px; padding-right: 20px">
        <div class="panel panel-primary" >
            <div  class="panel-heading">Consulta de Pessoas<asp:Label ID ="lblTipo" runat="server"></asp:Label><div class="messagealert" id="alert_container"></div></div>
                ...
                <div id="Tabs" role="tabpanel" >
                    ...
                    <div class="tab-content" runat="server" id="PanelContext">
                            ...
                            <asp:UpdatePanel ID="InsertEmployeeUpdatePanel" runat="server" UpdateMode="Always">
                                <ContentTemplate>
                                    ...
                                    <div class="row" style="background-color:white;border:none;">
                                        ...
                                        <div class="col-md-6" >
                                            <div class="input-group">
                                                <span class="input-group-addon">Grupo pessoa: &nbsp;&nbsp;</span>
                                                <asp:DropDownList ID="ddlGrupoPessoa" CssClass="form-control js-example-basic-single" runat="server" Font-Size="Small" Width="100%" >
                                    ...
                                    <div class="container-fluid">
                                        <div class="row" style="background-color:white;border:none;">
                                            ...
                                            <div class="col-md-2" >
                                                <asp:DropDownList ID="ddlRegistros" CssClass="form-control" runat="server" Font-Size="Medium">
                                            ...
                                            <div class="col-md-3" >
                                                <asp:DropDownList ID="ddlTipoPessoa" CssClass="form-control" runat="server" Font-Size="Medium">
                                                    ...
                                                    <asp:ListItem Value="1" Text="Fornecedores"></asp:ListItem>
                                                    <asp:ListItem Value="6" Text="Compradores"></asp:ListItem>
                                                    <asp:ListItem Value="2" Text="Clientes"></asp:ListItem>
                                                    <asp:ListItem Value="3" Text="Transportadoras"></asp:ListItem>
                                                    <asp:ListItem Value="4" Text="Usuários"></asp:ListItem>
                        ...
                        <div role="tabpanel" class="tab-pane" id="consulta" style="padding-left: 20px; padding-top: 20px; padding-right: 20px; font-size: small;">
                            ...
                            <asp:LinkButton ID="btnImprimirRelatorioMatriculados" runat="server" CssClass="btn btn-warning" OnClick="btnImprimirRelatorioMatriculados_Click" title="Fazer download relátorio de matriculados(s) com foto(s)" Height="34">
                                <span aria-hidden="true" class="glyphicon glyphicon-list-alt"></span> Relatório Matriculados
                            </asp:LinkButton>
                            <asp:LinkButton ID="btnImprimirRelatorioRepresentantes" runat="server" CssClass="btn bg-light" OnClick="btnImprimirRelatorioRepresentantes_Click" title="Fazer download relátorio de representantes" Height="34">
                                <span aria-hidden="true" class="glyphicon glyphicon-list-alt"></span> Relatório Representantes
                            </asp:LinkButton>
                            <br />
                            <br />

                            <asp:GridView ID="grdGrid" runat="server" Width="100%" CssClass="table table-bordered table-striped "
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Cpl_Estado" HeaderText="Estado"   ItemStyle-CssClass="noprint" HeaderStyle-CssClass="noprint" SortExpression="Cpl_Estado" />
                                    <asp:BoundField DataField="Cpl_Municipio" HeaderText="Municipio"   ItemStyle-CssClass="noprint" HeaderStyle-CssClass="noprint" SortExpression="Cpl_Municipio" />
                                    <asp:BoundField DataField="Cpl_Bairro" HeaderText="Bairro"  ItemStyle-CssClass="noprint" HeaderStyle-CssClass="noprint" SortExpression="Cpl_Bairro" />
                                    <asp:BoundField DataField="CodigoSisAnterior" HeaderText="Cód.Ant." SortExpression="CodigoSisAnterior"  HeaderStyle-CssClass=" noprint" ItemStyle-CssClass=" noprint"/>
                                    <asp:TemplateField HeaderText="Repres." HeaderStyle-CssClass="centerHeaderText noprint" ItemStyle-CssClass="centerHeaderText noprint">
                                        <ItemTemplate>
                                            <div class="dropdown">  
                                                <asp:LinkButton runat="server" type="button" class="btn btn-default" data-toggle="dropdown" Visible='<%# Eval("MostrarBotaoRepresentantes") %>'>
                                                    <span class="glyphicon glyphicon-eye-open"></span></span></span>
                                                </asp:LinkButton>
                                                <div class="dropdown-menu dropdown-menu-center " style="width:200px">
                                                    <div class="col-md-12" >
                                                        <p style="padding-top:10px;"><%# Eval("Cpl_Representantes").ToString().Replace("³","</br></br>") %></p>
                                                    </div>
                                                </div>
                                            </div> 
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Acesso" ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="centerHeaderText" >
                                        <ItemTemplate>
                                            <div class="dropdown">  
                                                <asp:LinkButton ID="btnSelecionar" runat="server" CssClass="btn btn-link buttonGrid" UseSubmitBehavior="false"
                                                            Visible='<%# btnSelecionar %>' CommandName="Selecionar"
                                                            CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" > 
                                                    <img runat="server" src="../../Images/Acessar.svg" width="20" height="20"/>
                                                    </asp:LinkButton>
                                                    <asp:LinkButton runat="server" type="button" class="btn btn-link dropdown-toggle buttonGrid" data-toggle="dropdown"  Visible='<%# btnOpcoes %>'>
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">                                                    
                                                    <li><a><asp:linkButton runat="server" ID="opEditar" CssClass="listButton"
                                                            Text="Geral"
                                                            CommandName="Geral"
                                                            CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" ><span class="glyphicon glyphicon-globe" style="margin-right:10px!important"></span>Geral</asp:linkButton></a></li>
                                                    <li><a><asp:linkButton runat="server" ID="opDuplicar" CssClass="listButton"
                                                            Text="Fincanceiro"
                                                            CommandName="Financeiro"
                                                            CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" ><span class="glyphicon glyphicon-briefcase" style="margin-right:10px!important"></span>Financeiro</asp:linkButton></a></li>
                                                    
                                                    <li><a><asp:linkButton runat="server" ID="opConsultar" CssClass="listButton"
                                                            Text="Comercial"
                                                            CommandName="Comercial"
                                                            CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" ><span class="glyphicon glyphicon-shopping-cart" style="margin-right:10px!important"></span>Comercial</asp:linkButton></a></li>
                                                   
                                                    <li><a><asp:linkButton runat="server" ID="opAutorizar" CssClass="listButton" 
                                                            Text="Fiscal"  
                                                            CommandName="Fiscal"
                                                            CommandArgument="<%# ((GridViewRow) Container).RowIndex %>"
                                                            ><span class="glyphicon glyphicon-usd" style="margin-right:10px!important"></span>Fiscal</asp:linkButton></a></li>  
                                                    <li><a><asp:linkButton runat="server" ID="LinkButton1" CssClass="listButton" 
                                                            Text="Histórico"  
                                                            CommandName="Historico"
                                                            CommandArgument="<%# ((GridViewRow) Container).RowIndex %>"
                                                            ><span class="glyphicon glyphicon-align-right" style="margin-right:10px!important"></span>Histórico</asp:linkButton></a></li>  
                                                </ul>
                                            </div>
                                        </ItemTemplate>
                                    </asp:TemplateField>
