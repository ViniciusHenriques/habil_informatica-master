...
{
    public partial class ConMovAcesso : System.Web.UI.Page
    {
        ...
        protected void MontaFiltro(object sender, EventArgs e)
        {
            ...
            Lista = d.ListarCamposView("VW_MOV_ACESSO");
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Session["TabFocadaConAcesso"] != null)
            {
                PanelSelect = Session["TabFocadaConAcesso"].ToString();
            }
            else
            {
                PanelSelect = "home";
                Session["TabFocadaConAcesso"] = "home";
                txtFiltro11.Focus();
            }
        ...
        protected void btnConsultar_Click(object sender, EventArgs e)
        {
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_MOV_ACESSO", lblFiltroData1.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_MOV_ACESSO", lblFiltroData2.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_MOV_ACESSO", lblFiltroData3.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_MOV_ACESSO", lblFiltro1.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_MOV_ACESSO", lblFiltro2.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_MOV_ACESSO", lblFiltro3.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_MOV_ACESSO", lblFiltro4.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_MOV_ACESSO", lblFiltro5.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_MOV_ACESSO", lblFiltro6.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_MOV_ACESSO", lblFiltro7.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_MOV_ACESSO", lblFiltro8.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_MOV_ACESSO", lblFiltro9.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_MOV_ACESSO", lblFiltro10.ToolTip).ToString().ToUpper();
            ...
            Session["LST_MOVACESSO"] = lista;
            MovAcessoDAL r = new MovAcessoDAL();
            grdGrid.DataSource = r.ListarMovAcessosCompleto(lista);
            grdGrid.DataBind();
            if (grdGrid.Rows.Count == 0)
                ShowMessage("Movimentação de Acesso(s) não encontrada(s) mediante a pesquisa realizada.", MessageType.Info);
        }
        protected void grdGrid_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (Session["IncEmpresa"] != null)
            {
                Session["IncEmpresa2"] = HttpUtility.HtmlDecode(grdGrid.SelectedRow.Cells[0].Text) + "³" + HttpUtility.HtmlDecode(grdGrid.SelectedRow.Cells[1].Text);
                Response.Redirect("~/Pages/Empresas/CadEmpresa.aspx");
            }
            else
            {
                if (Session["IncCompradorAcesso"] != null)
                {
                    List<Comprador> listCadComprador = new List<Comprador>();
                    listCadComprador = (List<Comprador>)Session["IncCompradorAcesso"];
                    listCadComprador[0].CodigoComprador = Convert.ToInt64(HttpUtility.HtmlDecode(grdGrid.SelectedRow.Cells[0].Text));
                    Session["IncCompradorAcesso"] = listCadComprador;
                    Response.Redirect("~/Pages/Acessos/CadComprador.aspx");
                }
                else
                {
                    Session["ZoomMovAcesso"] = HttpUtility.HtmlDecode(grdGrid.SelectedRow.Cells[0].Text) + "³";
        ...
        {
            Session["ZoomAcesso"] = null;
            Session["CadAcesso"] = null;
            Response.Redirect("~/Pages/Acesso/ManMovAcesso.aspx");
        }
        ...
        {
            Response.Redirect("~/Pages/Acesso/RelMovAcesso.aspx");
        }
    }
}