...
{
    public partial class ConTipoServico : System.Web.UI.Page
    {
        ...
        protected void MontaFiltro(object sender, EventArgs e)
        {
            ...
            Lista = d.ListarCamposSQL("TIPO_DE_SERVICO");
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Session["LST_TIPOSERVICO"] != null)
            {
                listaT = (List<DBTabelaCampos>)Session["LST_TIPOSERVICO"];
                if (listaT.Count != 0)
        ...
        protected void btnConsultar_Click(object sender, EventArgs e)
        {
            ...
            {
                strTipo = d.ListarTipoCampoSQL("TIPO_DE_SERVICO", lblFiltro1.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoSQL("TIPO_DE_SERVICO", lblFiltro2.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoSQL("TIPO_DE_SERVICO", lblFiltro3.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoSQL("TIPO_DE_SERVICO", lblFiltro4.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoSQL("TIPO_DE_SERVICO", lblFiltro5.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoSQL("TIPO_DE_SERVICO", lblFiltro6.ToolTip).ToString().ToUpper();
            ...
            Session["LST_TIPOSERVICO"] = listaT;
            TipoServicoDAL r = new TipoServicoDAL();
            grdGrid.DataSource = r.ListarTipoServicoCompleto(listaT);
            grdGrid.DataBind();
            if (grdGrid.Rows.Count == 0)
            {
                ShowMessage("Tipo(s) de Serviço(s) não encontrado(s) mediante a pesquisa realizada.", MessageType.Info);
                Session["LST_TIPOSERVICO"] = null;
            }
        }
        protected void grdGrid_SelectedIndexChanged(object sender, EventArgs e)
        {          
            Session["ZoomTipoServico"] = HttpUtility.HtmlDecode(grdGrid.SelectedRow.Cells[0].Text) + "³";
            Response.Redirect("~/Pages/Servicos/cadTipoServico.aspx");
        }
