<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPrincipal.Master" AutoEventWireup="true" CodeBehind="ConSolAtendimento.aspx.cs" 
    Inherits="SoftHabilInformatica.Pages.Servicos.ConSolAtendimento"  MaintainScrollPositionOnPostback="True" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cttCorpo" runat="server">
    ...
    <div id="divNavTeste" style="padding-left: 20px; padding-top: 20px; padding-right: 20px">
        <div class="panel panel-primary" >
            <div  class="panel-heading ">Consulta de Solicitação de Atendimento
                                           ...
                                           <div class="col-md-3" >
                                                <div class="input-group">
                                                    ...
                                                    <asp:DropDownList ID="ddlTipoBaixa" CssClass="form-control" runat="server" Font-Size="Medium" >
                                                        ...
                                                        <asp:ListItem Value="1" Text="Não iniciado"></asp:ListItem>
                                                        <asp:ListItem Value="2" Text="Desenvolvimento"></asp:ListItem>
                                                        <asp:ListItem Value="3" Text="Encerrado"></asp:ListItem>
                                                        <asp:ListItem Value="4" Text="Homologação"></asp:ListItem>
