...
namespace HabilInformatica.Pages.Servicos.RPT {
    ...
    public class RelOrdServico : ReportClass {
        
        public RelOrdServico() {
        }
        
        public override string ResourceName {
            get {
                return "RelOrdServico.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "HabilInformatica.Pages.Servicos.RPT.RelOrdServico.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRelOrdServico : Component, ICachedReport {
        
        public CachedRelOrdServico() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RelOrdServico rpt = new RelOrdServico();
            rpt.Site = this.Site;
            return rpt;
        }
