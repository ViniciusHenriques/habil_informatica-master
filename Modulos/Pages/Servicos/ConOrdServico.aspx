<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPrincipal.Master" AutoEventWireup="true" CodeBehind="ConOrdServico.aspx.cs" 
    Inherits="SoftHabilInformatica.Pages.Servicos.ConOrdServico"  MaintainScrollPositionOnPostback="True" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cttCorpo" runat="server">
    ...
    <div id="divNavTeste" style="padding-left: 20px; padding-top: 20px; padding-right: 20px">
        <div class="panel panel-primary ">
            <div  class="panel-heading panel-heading-padrao" >Consulta de Ordem de Serviço
                                        ...
                                        <div class="row" style="background-color:white;border:none;">
                                           ...
                                           <div class="col-md-3" >
                                                <div class="input-group">
                                                    ...
                                                    <asp:DropDownList ID="ddlClassificacao" CssClass="form-control" runat="server" Font-Size="Medium" >
                                                         
                                                        <asp:ListItem Value="0" Text="Todos" ></asp:ListItem>
                                                        <asp:ListItem Value="1" Text="Serviço"></asp:ListItem>
                                                        <asp:ListItem Value="2" Text="Fatura"></asp:ListItem>
                                                    </asp:DropDownList>
                                                </div>
                                            </div>
                        ...
                        <div role="tabpanel" class="tab-pane" id="consulta" style="padding-left: 20px; padding-top: 20px; padding-right: 20px; font-size: small;">
                            ...
                            <asp:GridView ID="grdGrid" runat="server" CssClass="table table-bordered table-striped " Width="100%" 
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Cpl_Situacao" HeaderText="Situação" DataFormatString="{0:dd/MM/yyyy}" />
                                    <asp:TemplateField HeaderText="Classificação" ItemStyle-CssClass="centerVertical col-md-1" >
                                        <ItemTemplate>
                                            <label  class="badge <%# Eval("Cpl_Classificacao").ToString() %>" id="situacaoSpan" ><%# Eval("Cpl_Classificacao").ToString() %></label>                                            
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Acesso" ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="centerHeaderText col-md-1" >
                                        <ItemTemplate>
                                            <div class="dropdown">  
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <li><a><asp:linkButton runat="server" ID="opImprimir" CssClass="listButton"
