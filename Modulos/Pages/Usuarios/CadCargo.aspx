<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPrincipal.Master" AutoEventWireup="true" CodeBehind="CadCargo.aspx.cs" Inherits="SoftHabilInformatica.Pages.Usuarios.CadCargo" %>
    ...
    <div id="divNavTeste" style="padding-left:20px;padding-top:20px;padding-right:20px" >
        ...
        <ContentTemplate>
            ...
            <div  class="panel panel-primary" >
                <div class="panel-heading">Cadastro de Cargos
                ...
                <div class="panel-body">
                   ...
                   <br/><br/>
                    <div class="input-group">
                        <span class="input-group-addon">Código do Cargo : &nbsp;&nbsp;&nbsp; </span>
                    ...
                    <br />
                    <div class="input-group">
                        <span class="input-group-addon">Descrição do Cargo : </span>
