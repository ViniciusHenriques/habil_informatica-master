...
{
    public partial class ConBanco : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Session["LST_BANCO"] != null)
            {
                listaT = (List<DBTabelaCampos>)Session["LST_BANCO"];
                if (listaT.Count != 0)
        ...
        protected void btnConsultar_Click(object sender, EventArgs e)
        {
            ...
            {
                strTipo = d.ListarTipoCampoSQL("BANCO", lblFiltro1.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoSQL("BANCO", lblFiltro2.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoSQL("BANCO", lblFiltro3.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoSQL("BANCO", lblFiltro4.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoSQL("BANCO", lblFiltro5.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoSQL("BANCO", lblFiltro6.ToolTip).ToString().ToUpper();
            ...
            Session["LST_BANCO"] = listaT;
            BancoDAL r = new BancoDAL();
            grdGrid.DataSource = r.ListarBancosCompleto(listaT);
            grdGrid.DataBind();
            if (grdGrid.Rows.Count == 0)
            {
                ShowMessage("Banco(s) não encontrado(s) mediante a pesquisa realizada.", MessageType.Info);
                Session["LST_BANCO"] = null;
            }
        }
        protected void grdGrid_SelectedIndexChanged(object sender, EventArgs e)
        {
            Session["ZoomBanco"] = HttpUtility.HtmlDecode(grdGrid.SelectedRow.Cells[0].Text) + "³";
            Response.Redirect("~/Pages/financeiros/cadBanco.aspx");
        }
