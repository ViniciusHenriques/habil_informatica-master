    <%@ Page Title="" Language="C#" MasterPageFile="~/MasterPrincipal.Master" AutoEventWireup="true" CodeBehind="CadFmaPagamento.aspx.cs" Inherits="SoftHabilInformatica.Pages.Financeiros.CadFmaPagamento" %>
    ...
    <div id="divNavTeste" style="padding-left:20px;padding-top:20px;padding-right:20px" >
        ...
        <ContentTemplate>
            ...
            <div  class="panel panel-primary" >
                <div class="panel-heading">Cadastro de Formas de Pagamento
                ...
                <div class="panel-body">
                   ...
                   <br/><br/><br/>
                    ...
                    <div class="input-group">
                        <span class="input-group-addon">Código da Forma de Pagamento NF-e : </span>
                        <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                            <ContentTemplate>
                                <asp:DropDownList ID="DdlFormaPagamento" runat="server"  AutoPostBack="True" CssClass="form-control js-example-basic-single" OnSelectedIndexChanged="DdlFormaPagamento_SelectedIndexChanged" > 
                                </asp:DropDownList>
                            </ContentTemplate>
                            <Triggers>
                    ...
                    <br />
                    <div class="input-group">
                        <span class="input-group-addon">Código da Bandeira NF-e : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;  </span>
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server" >
                            <ContentTemplate>
                                <asp:DropDownList ID="DdlBandeira" runat="server"  AutoPostBack="True" CssClass="form-control js-example-basic-single" OnSelectedIndexChanged="DdlBandeira_SelectedIndexChanged"> 
                                </asp:DropDownList>

                            </ContentTemplate>
                            <Triggers>
                                <asp:PostBackTrigger ControlID="DdlBandeira" />
                            </Triggers>
