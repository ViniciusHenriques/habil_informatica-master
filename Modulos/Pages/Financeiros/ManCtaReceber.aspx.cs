...
{
    public partial class ManCtaReceber : System.Web.UI.Page
    {
        ...
        protected void CarregaTiposSituacoes()
        {
            ...
            TipoDocumentoDAL tipoDoc = new TipoDocumentoDAL();
            ddlTipoDocumento.DataSource = tipoDoc.ListarTipoDocumento("","","","");
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Session["Pagina"].ToString() != Request.CurrentExecutionFilePath)
            {
                ...
                {
                    string s = Session["ZoomDocCtaReceber"].ToString();
                    ...
                    if (s != "³")
                    {
                        ...
                        foreach (string word in words)
                        {
                            if (word != "")
                            {
                                ...
                                Doc_CtaReceberDAL docDAL = new Doc_CtaReceberDAL();
                                ...
                                {
                                    Doc_CtaReceber docOriginal = new Doc_CtaReceber();
                ...
                else
                {
                    ...
                    if (Session["Ssn_CtaReceber"] == null)
                    {
                ...
                if (Session["Ssn_CtaReceber"] != null)
                {
                    ...
                    CarregaTiposSituacoes();
                    if (Session["Ssn_CtaReceber2"] != null)
                    {
                        string s = Session["Ssn_CtaReceber2"].ToString();
                        Session["Ssn_CtaReceber2"] = null;
        ...
        protected void PreencheDados(int credor)
        {
            ...
            txtNroDocumento.Text = Convert.ToString(doc.DGDocumento);
            ddlTipoCobranca.SelectedValue = Convert.ToString(doc.CodigoCobranca);
            //ddlCredor.SelectedValue = Convert.ToString(doc.CodigoVendedor);
            if (credor == 0)
            {
        ...
        {
            Doc_CtaReceberDAL doc = new Doc_CtaReceberDAL();
        ...
        protected void btnSalvar_Click(object sender, EventArgs e)
        {
            ...
            Doc_CtaReceberDAL pe = new Doc_CtaReceberDAL();
        ...
        protected void btnNovAnexo_Click(object sender, EventArgs e)
        {
            ...
            CompactaDocumento();
            Session["NovaBaixa"] = ListaBaixa;
            Response.Redirect("~/Pages/Financeiros/ManAnexo.aspx?cad=2");
        }
        ...
        {
            Doc_CtaReceber contasPgar = new Doc_CtaReceber();
            ...
            Session["Ssn_CtaReceber"] = contasPgar;
        }
        protected void ConCredor(object sender, EventArgs e)
        {
            CompactaDocumento();
            Session["LST_CADPESSOA"] = null;
            Response.Redirect("~/Pages/Pessoas/ConPessoa.aspx?Cad=5");
        ...
        protected void SelectedCredor(object sender, EventArgs e)
        {
            ...
            if (txtCodDocumento.Text != "Novo")
            {
                ...
                {
                    ShowMessage("Você alterou o devedor! A Pessoa do Documento irá mudar...", MessageType.Info);
                }
            }
            ...
            p2 = pessoa.PesquisarCliente(codigoCredor);
        ...
        protected void Anexo()
        {
            /////////////////////////////////////////////////////////////////////////

            //byte[] fotoLocal = null;
            ////            if (System.IO.File.Exists("D:\\Web\\Habil_Informatica\\Habil_Informatica\\Habil_Informatica\\Images\\CapturaNow.png"))
            //if (System.IO.File.Exists(Server.MapPath(@"~\Images\CapturaNow.png")))
            //{
            //    //                Image image = Image.FromFile(@"D:\\Web\\Habil_Informatica\\Habil_Informatica\\Habil_Informatica\\Images\\CapturaNow.png");

            //    Image image = Image.FromFile(Server.MapPath(@"~\Images\CapturaNow.png"));
            ...
            //    //                System.IO.File.Delete(@"D:\\Web\\Habil_Informatica\\Habil_Informatica\\Habil_Informatica\\Images\\CapturaNow.png");
            //    System.IO.File.Delete(Server.MapPath(@"~\Images\CapturaNow.png"));
            //}
