...
{
    public partial class RelCtaPagar : System.Web.UI.Page
    {
        ...
        private void MontaCrystal()
        {
            ...
            if (Session["LST_DOCCTAPAGAR"] != null)
                lista = (List<DBTabelaCampos>)Session["LST_DOCCTAPAGAR"];
                ...
                if (filtro10 == 0)
                {
                    if (tab.Filtro == "DG_DOCUMENTO")
                    {
                        ...
                        if (tab.Inicio == "")
                            ...
                            filtro = tab.Inicio + " a " + tab.Fim;
                        RptDoc.DataDefinition.FormulaFields["Filtro" + i].Text = "'Doc. Digitado: " + filtro.ToUpper() + " '";
            ...
            if (Session["FILTROS"] != null && Session["COD_FILTROS"] != null)
            {
                ...
                RptDoc.SetDataSource(r.RelCtaPagarCompleto(lista, CodigoFiltros));
            }
