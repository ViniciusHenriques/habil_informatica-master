<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPrincipal.Master" AutoEventWireup="true" CodeBehind="CadPlanoContas.aspx.cs" Inherits="SoftHabilInformatica.Pages.Financeiros.CadPlanoContas" MaintainScrollPositionOnPostback="True" %>
    ...
    <div id="divNavTeste" style="padding-left:20px;padding-top:20px;padding-right:20px" >
        ...
        <ContentTemplate>
            ...
            <div  class="panel panel-primary" >
                <div class="panel-heading">Cadastro de Plano de Contas
                ...
                <div class="panel-body">
                   ...
                   <br/><br/><br/>
                    <div class="input-group">
                        <span class="input-group-addon">Código da Plano de Conta : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; </span>
                    ...
                    <br />
                    <div class="input-group">
                        <span class="input-group-addon">Código Reduzido : &nbsp;&nbsp;&nbsp; </span>
                        <asp:TextBox ID="txtCodReduzido"  CssClass="form-control" name="txtDescricao" TabIndex="2" runat="server" MaxLength="50" />
                    </div>
                    <br />
                    <br />
                    <div class="input-group">
                        <span class="input-group-addon">Descrição do Plano de Conta : &nbsp;&nbsp;&nbsp; </span>
      ...
      <div class="modal-dialog" role="document" style ="height:100%;width:300px">
        <div class="modal-content" >
          ...
          <div class="modal-body">
              Deseja Excluir esta Plano de Conta ?
          </div>
