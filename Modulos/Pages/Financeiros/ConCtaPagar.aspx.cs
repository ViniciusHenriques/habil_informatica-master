...
{
    public partial class ConCtaPagar : System.Web.UI.Page
    {
        ...
        protected void MontaFiltro(object sender, EventArgs e)
        {
            ...
            Lista = d.ListarCamposView("VW_DOC_CTA_PAGAR");
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Session["LST_DOCCTAPAGAR"] != null)
            {
                listaT = (List<DBTabelaCampos>)Session["LST_DOCCTAPAGAR"];
                if (listaT.Count != 0)
            ...
            {
                if (Session["ZoomDocCtaPagar2"].ToString() == "RELACIONAL")
                {
                    pnlPainel.Visible = false;
                    cmdSair.Visible = false;
                }
        ...
        protected void btnConsultar_Click(object sender, EventArgs e)
        {
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_DOC_CTA_PAGAR", lblFiltroData1.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_DOC_CTA_PAGAR", lblFiltroData2.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_DOC_CTA_PAGAR", lblFiltroData3.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_DOC_CTA_PAGAR", lblFiltro1.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_DOC_CTA_PAGAR", lblFiltro2.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_DOC_CTA_PAGAR", lblFiltro3.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_DOC_CTA_PAGAR", lblFiltro4.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_DOC_CTA_PAGAR", lblFiltro5.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_DOC_CTA_PAGAR", lblFiltro6.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_DOC_CTA_PAGAR", lblFiltro7.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_DOC_CTA_PAGAR", lblFiltro8.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_DOC_CTA_PAGAR", lblFiltro9.ToolTip).ToString().ToUpper();
            ...
            {
                strTipo = d.ListarTipoCampoView("VW_DOC_CTA_PAGAR", lblFiltro10.ToolTip).ToString().ToUpper();
            ...
            Session["LST_DOCCTAPAGAR"] = listaT;
            ...
            grdGrid.DataSource = r.ListarDoc_CtaPagarCompleto(listaT,TipoBaixa,TpCobranca, CodPlanoConta);
            grdGrid.DataBind();
            if (grdGrid.Rows.Count == 0)
            {
                ShowMessage("Contas a Pagar não encontrado(s) mediante a pesquisa realizada.", MessageType.Info);
                Session["LST_DOCCTAPAGAR"] = null;
            }
        }
        ...
        {
            Response.Redirect("~/Pages/Financeiros/RelCtaPagar.aspx");
        }
        ...
        protected void grdGrid_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                ...
                Session["ZoomDocCtaPagar"] = Codigo + "³";
                ...
                if (x == "Editar")
                {
                    if (lista1.Count > 0 && !lista1[0].AcessoCompleto)
                    {
                        ...
                        {
                            ShowMessage("Sem permissão para editar contas a pagar", MessageType.Info);
                            return;
                        }
                    }
                    Session["Ssn_CtaReceber"] = null;
                ...
                else if (x == "Duplicar")
                {
                    if (lista1.Count > 0 && !lista1[0].AcessoCompleto)
                    {
                        ...
                        {
                            ShowMessage("Sem permissão para incluir contas a pagar", MessageType.Info);
                            return;
                        }
                    }
        ...
        protected void btnConfirmarDuplicar_Click(object sender, EventArgs e)
        {
            ...
            { 
                ...
                {
                    decimal CodigoDocumento = Convert.ToDecimal(Session["ZoomDocCtaPagar"].ToString().Split('³')[0]);
