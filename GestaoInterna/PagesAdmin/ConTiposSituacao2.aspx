<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConTiposSituacao2.aspx.cs" Inherits="GestaoInterna.PagesAdmin.ConTiposSituacao2" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div class="input-group">
          <span class="input-group-addon" id="basic-addon1">Tipo ou Situação Selecionado</span>
        ...
        <asp:GridView ID="grdSituacao" runat="server" Width="100%" 
                    ...
                    AllowPaging="true" PageSize= "10" OnPageIndexChanging="grdSituacao_PageIndexChanging" 
