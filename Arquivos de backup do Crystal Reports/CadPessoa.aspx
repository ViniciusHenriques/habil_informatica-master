                        ...
                        <asp:UpdatePanel ID="UpdatePanel6" runat="server" UpdateMode="Always">
                            <ContentTemplate>
                                <div class="row" style="background-color:white;border:none;">
                                    ...
                                    <div class="col-md-6" style="background-color:white;border:none;text-align:left;font-size:x-small;">
                                        <label for="usr" style ="margin-top:1px;">Nome Fantasia</label>
                                         ...
                                         <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Always">
                                            <ContentTemplate>
                                                ...
                                                <div class="col-md-4" style="background-color:white;border:none;text-align:left;font-size:x-small;"  >
                                                    ...
                                                    <asp:DropDownList ID="ddlGpoPessoa" runat="server" TabIndex="2" CssClass="form-control js-example-basic-single" Width="100%" Height="33"></asp:DropDownList>
                                                
                                                </div>
                                           
                                                <div class="col-md-1" style="background-color: white; border: none; text-align: left; font-size: x-small; margin-top:19px">
                                                
                                                    <asp:LinkButton ID="BtnAddGpoPessoa" runat="server" Text="Adicionar" TabIndex="10" CssClass="btn btn-success" OnClick="BtnAddGpoPessoa_Click" style="height:33px!important;padding-top:7px" > 
                                                    <span aria-hidden="true" title="Adicionar Grupo de Pessoa" class="glyphicon glyphicon-plus"></span>
                                                    </asp:LinkButton>
                                                </div>

                                            </ContentTemplate>
                                            <Triggers>
                                                <asp:PostBackTrigger ControlID="ddlGpoPessoa" />
