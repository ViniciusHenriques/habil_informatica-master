<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPrincipal.Master" AutoEventWireup="true" CodeBehind="ConCategoria.aspx.cs" Inherits="SoftHabilInformatica.Pages.Produtos.ConCategoria" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cttCorpo" runat="server">
    ...
    <div id="divNavTeste" style="padding-left:20px;padding-top:20px;padding-right:20px" >
        <div class="panel panel-primary" >
            <div  class="panel-heading">Consulta de Categorias
            ...
            <div class="panel-body">
                ...
                <asp:GridView ID="grdGrid" runat="server" Width="100%" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="CodigoCategoria" HeaderText="Código da Categoria" />
                        <asp:BoundField DataField="DescricaoCategoria" HeaderText="Descrição da Categoria" />
                        <asp:BoundField DataField="DescricaoDepartamento" HeaderText="Descrição do Departamento" />
                        <asp:BoundField DataField="DescricaoGpoComissao" HeaderText="Descrição do Grupo de Comissão" />
