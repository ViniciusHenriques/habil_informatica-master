        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12" style="font-size:x-small;margin-top:3px;padding-right:20px;padding-left:20px">
                    ...
                    <asp:UpdatePanel ID="UpdatePanel6" runat="server" UpdateMode="Always">
                        <ContentTemplate>
                            <div class="col-md-6" style="font-size:x-small;margin-top:3px;padding-right:20px;padding-left:20px" >
                                ...
                                <asp:TextBox ID="txtCreditoCompra" Text="0,00" CssClass="form-control" TabIndex="4" runat="server" MaxLength="18" AutoPostBack="true" OnTextChanged="txtCreditoCompra_TextChanged" onFocus="this.select()"/>
                            </div>
                        </ContentTemplate> 
                        <Triggers>
                            <asp:AsyncPostBackTrigger ControlID="txtCreditoCompra" EventName="TextChanged" />
                        </Triggers>
                    </asp:UpdatePanel>
                </div>
            </div>
