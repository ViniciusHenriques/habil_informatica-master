<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPrincipal.Master" AutoEventWireup="true" CodeBehind="ConTipoDocumento.aspx.cs" Inherits="SoftHabilInformatica.Pages.Empresas.ConTipoDocumento" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cttCorpo" runat="server">
    ...
    <div id="divNavTeste" style="padding-left:20px;padding-top:20px;padding-right:20px" >
        <div class="panel panel-primary" >
            <div  class="panel-heading">Consulta de Tipos de Documento
            ...
            <div class="panel-body">
                ...
                <br />    
                <asp:GridView ID="grdTipoDocumento" runat="server" Width="100%" 
                    CssClass ="table table-bordered table-hover table-striped" 
                    GridLines="None" AutoGenerateColumns="False" 
                    Font-Size="8pt" 
                    OnSelectedIndexChanged="grdTipoDocumento_SelectedIndexChanged" 
                    AllowPaging="true" PageSize= "10" 
                    OnPageIndexChanging="grdTipoDocumento_PageIndexChanging" 
                    ...
                    <Columns>
                        <asp:BoundField DataField="CodigoTipoDocumento" HeaderText="Código" />
                        <asp:BoundField DataField="DescricaoTipoDocumento" HeaderText="Descrição" />
