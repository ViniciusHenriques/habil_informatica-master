<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPrincipal.Master" AutoEventWireup="true" CodeBehind="CadDepartamento.aspx.cs" Inherits="SoftHabilInformatica.Pages.Produtos.CadDepartamento" %>
    ...
    <div id="divNavTeste" style="padding-left:20px;padding-top:20px;padding-right:20px" >
        ...
        <ContentTemplate>
            ...
            <div  class="panel panel-primary" >
                <div class="panel-heading">Cadastro de Departamentos
                   ...
                   <br/><br/>
                    <div class="col-md-8">
                        <div class="input-group ">
                            <span class="input-group-addon">Código da Departamento : &nbsp;&nbsp;&nbsp; </span>
                    ...
                    <div class="col-md-12">
                        <div class="input-group">
                            <span class="input-group-addon">Descrição da Departamento : </span>
      ...
      <div class="modal-dialog" role="document" style ="height:100%;width:300px">
        <div class="modal-content" >
          ...
          <div class="modal-body">
              Deseja Excluir esta Departamento? ?
          </div>
