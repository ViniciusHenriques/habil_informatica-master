<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPrincipal.Master" AutoEventWireup="true" CodeBehind="CadFabricante.aspx.cs" Inherits="SoftHabilInformatica.Pages.Produtos.CadFabricante" %>
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="input-group">
                            <span class="input-group-addon">Código do Fabricante : &nbsp;&nbsp;&nbsp; </span>
                        ...
                        <br />
                        <div class="input-group">
                            <span class="input-group-addon">Descrição do Fabricante : </span>
        ...
        <div class="modal-dialog" role="document" style="height: 100%; width: 300px">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Deseja Excluir este Fabricante?
                </div>
