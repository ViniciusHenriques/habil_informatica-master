                ...
                <div class="panel panel-default">
                 ...
                 <div class="row" style="background-color:white;border:none;margin-top:13px;" >
                    ...
                    <div class="col-md-6" style="background-color:white;border:none;text-align:left;font-size:x-small;">
                            ...
                            <asp:DropDownList ID="ddlRegTributario" runat="server" AutoPostBack="false" TabIndex="7" CssClass="form-control js-example-basic-single" Width="100%" Height="100%"></asp:DropDownList>
                    ...
                    <div class="col-md-6" style="background-color:white;border:none;text-align:left;font-size:x-small;">
                        ...
                        <asp:DropDownList ID="ddlGpoTribPessoa" runat="server" AutoPostBack="false" TabIndex="11" CssClass="form-control js-example-basic-single" Width="100%" Height="100%"></asp:DropDownList>
