<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPrincipal.Master" AutoEventWireup="true" CodeBehind="ConMarca.aspx.cs" Inherits="SoftHabilInformatica.Pages.Produtos.ConMarca" %>
                ...
                <div id="Tabs" role="tabpanel">
                    ...
                    <div role="tabpanel" class="tab-pane" id="consulta" style="padding-left: 20px; padding-top: 20px; padding-right: 20px; font-size: small;">
                        ...
                        <asp:GridView ID="grdGrid" runat="server" Width="100%"
                            ...
                            <Columns>
                                <asp:BoundField DataField="CodigoMarca" HeaderText="Código" />
                                <asp:BoundField DataField="DescricaoMarca" HeaderText="Descrição" />
