<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPrincipal.Master" AutoEventWireup="true" CodeBehind="ConTipoCobranca.aspx.cs" Inherits="SoftHabilInformatica.Pages.Financeiros.ConTipoCobranca" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cttCorpo" runat="server">
    ...
    <div id="divNavTeste" style="padding-left:20px;padding-top:20px;padding-right:20px" >
        <div class="panel panel-primary" >
            <div  class="panel-heading">Consulta de Tipos de Cobrança
            ...
            <div class="panel-body">
                ...
                <div class="input-group">
                    ...
                    <asp:DropDownList ID="ddlRegistros" runat="server" Font-Size="Medium" OnSelectedIndexChanged="ddlRegistros_SelectedIndexChanged">
                        ...
                        <asp:ListItem Value="10000" Text="Todos" ></asp:ListItem>
                    </asp:DropDownList>              
                    Registros
                    &nbsp&nbsp&nbsp&nbsp    
                ...
                <asp:GridView ID="grdGrid" runat="server" Width="100%" 
                    ...
                    <Columns>
                        <asp:BoundField DataField="CodigoTipoCobranca" HeaderText="Código" />
                        <asp:BoundField DataField="DescricaoTipoCobranca" HeaderText="Descrição" />
