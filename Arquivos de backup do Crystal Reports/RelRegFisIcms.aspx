<%@ Page Title="" Language="C#" MasterPageFile="~/MasterRelacional.Master" AutoEventWireup="true" CodeBehind="RelRegFisIcms.aspx.cs" Inherits="HabilInformatica.Pages.Impostos.RelRegFisIcms" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cttRodape" runat="server">
   <div id="divNavTeste" style="padding-left:20px;padding-top:20px;padding-right:20px;font-size:small;" >
            ...
            <div class="panel panel-primary">
                <div class="panel-heading">Relatório Regras Fiscais de ICMS
