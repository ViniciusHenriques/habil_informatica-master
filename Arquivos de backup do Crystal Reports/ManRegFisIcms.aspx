                    ...
                    <div class="col-md-4" style="background-color: white; border: none; text-align: left; font-size: x-small;">
                        <asp:Panel ID="pnlAlterar" runat ="server" Visible ="true">
                            <div class="input-group">
                                ...
                                <asp:DropDownList ID="ddlAlteracao" runat="server" AutoPostBack="false" CssClass="form-control js-example-basic-single" TabIndex="3" Font-Size="Small">
                                    <asp:ListItem Text="Data de Vigência" Selected="True" Value="0" />
                                    <asp:ListItem Text="Combinação: Localização, Grupos, Aplicação e Operação" Value="1" />
                                    <asp:ListItem Text="Aplicação da Regra" Value="2" />
                                </asp:DropDownList>
                            </div>
                        </asp:Panel>
                    </div>
