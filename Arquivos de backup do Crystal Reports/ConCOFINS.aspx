<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPrincipal.Master" AutoEventWireup="true" CodeBehind="ConCOFINS.aspx.cs" Inherits="SoftHabilInformatica.Pages.Produtos.ConCOFINS" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cttCorpo" runat="server">
    ...
    <div id="divNavTeste" style="padding-left:20px;padding-top:20px;padding-right:20px" >
        <div class="panel panel-primary" >
            <div  class="panel-heading">Consulta de COFINS
            ...
            <div class="panel-body">
                ...
                <asp:GridView ID="grdGrid" runat="server" Width="100%" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="CodigoCOFINS" HeaderText="Código do COFINS" />
                        <asp:BoundField DataField="DescricaoCOFINS" HeaderText="Descricao" />
                        <asp:BoundField DataField="DescricaoTipo" HeaderText="Tipo" />
                        <asp:BoundField DataField="ValorCOFINS" HeaderText="Valor do COFINS" DataFormatString="{0:f}" />
