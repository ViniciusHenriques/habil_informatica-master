<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPrincipal.Master" AutoEventWireup="true" CodeBehind="ConGpoTribProduto.aspx.cs" 
    Inherits="SoftHabilInformatica.Pages.Impostos.ConGpoTribProduto" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cttCorpo" runat="server">
    ...
    <div id="divNavTeste" style="padding-left:20px;padding-top:20px;padding-right:20px" >
        ...
        <div class="panel panel-primary" >
            <div  class="panel-heading">Consulta de Grupos de Tributação da Produto
                    ...
                    <div class="tab-content" runat="server" id="PanelContext">
                        ...
                        <div role="tabpanel" class="tab-pane" id="consulta" style="padding-left:20px;padding-top:20px;padding-right:20px;font-size:small;"   >
                            ...
                            <asp:GridView ID="grdGrid" runat="server" Width="100%" 
                                ...
                                <Columns>
                                    <asp:BoundField DataField="CodigoGpoTribProduto" HeaderText="Código" />
