            ...
            <div class="panel-body">
                <div class="row" style="background-color: white; border: none;">
                    <div class="col-md-4" style="background-color: white; border: none; text-align: left; font-size: small;">
                        <asp:LinkButton ID="btnNovo" ToolTip="Novo E-mail" runat="server" Text="Novo E-mail" CssClass="btn btn-info" UseSubmitBehavior="false" OnClick="btnNovo_Click" Height ="60"> 
                            <span aria-hidden="true" title="Novo" class="glyphicon glyphicon-edit"><br/><br/>&nbsp;Novo</span>
                        </asp:LinkButton>

                        <asp:LinkButton ID="btnSair" ToolTip="Sair" runat="server" Text="Fechar" CssClass="btn btn-info" OnClick="btnSair_Click"   Height ="60">
                            <span aria-hidden="true" title="Fechar" class="glyphicon glyphicon-off"><br/><br/>&nbsp;Sair</span>
                        </asp:LinkButton>
                    </div>
                </div>
                <br />
