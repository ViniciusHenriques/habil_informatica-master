<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPrincipal.Master" AutoEventWireup="true" 
    CodeBehind="ManCtaPagar.aspx.cs" Inherits="SoftHabilInformatica.Pages.Financeiros.ManCtaPagar"  
                                        ...
                                        <ContentTemplate>
                                            ...
                                            <div class="col-md-4" style="background-color: white; border: none; text-align: left; font-size: x-small;">
                                                <label for="usr" style ="margin-top:1px;">Documento</label>
                                                 <asp:TextBox ID="txtNroDocumento" name="txtNroDocumento" AutoPostBack="False" CssClass="form-control" TabIndex="10" MaxLength="30" runat="server" />
                                            </div>
                                            ...
                                            <br /><br /><br /><br />
                                            <div class="col-md-6" >
                                                <label for="usr" style ="margin-top:1px; ">Código Credor</label>
                                                <div class="input-group " style="width:100%">
                                                    ...
                                                    <asp:LinkButton ID="LinkButton2" title="Pesquise os Clientes" runat="server" CssClass="form-control btn btn-primary" Width="10%"  OnClick="ConCredor" > 
                                            ...
                                            <div class="col-md-12" style="background-color: white; border: none; text-align: left; font-size: x-small;">
                                                ...
                                                <asp:TextBox ID="txtOBS" name="txtOBS" AutoPostBack="False" CssClass="form-control" MaxLength="300" TabIndex="16" runat="server" />
                                            </div>
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel4" runat="server" UpdateMode="Always">
                                        <ContentTemplate>
                                            ...
                                            <asp:GridView ID="grdAnexo" runat="server"
                                                ...
                                                <Columns>
                                                    <asp:BoundField DataField="CodigoAnexo" HeaderText="Seq."  />
