<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPrincipal.Master" AutoEventWireup="true" CodeBehind="ConTipoServico.aspx.cs" Inherits="SoftHabilInformatica.Pages.Servicos.ConTipoServico" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cttCorpo" runat="server">
    ...
    <div id="divNavTeste" style="padding-left:20px;padding-top:20px;padding-right:20px" >
        ...
        <div class="panel panel-primary " >
            <div  class="panel-heading panel-heading-padrao">Consulta de Tipos de Serviços
                    ...
                    <div class="tab-content" runat="server" id="PanelContext">
                        ...
                        <div role="tabpanel" class="tab-pane" id="consulta" style="padding-left:20px;padding-top:20px;padding-right:20px;font-size:small;"   >
                            ...
                            <asp:GridView ID="grdGrid" runat="server" CssClass="table table-bordered table-hover table-striped"
                                ...
                                <Columns>
                                    <asp:BoundField DataField="CodigoTipoServico" HeaderText="Código" />
                                    
                                    <asp:BoundField DataField="DescricaoTipoServico" HeaderText="Descrição" />
                                    <asp:BoundField DataField="ValorISSQN" HeaderText="Valor ISSQN" />
                                    <asp:BoundField DataField="CodigoCNAE" HeaderText="CNAE" ItemStyle-CssClass="noprint" HeaderStyle-CssClass="noprint"/>
