<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPrincipal.Master" AutoEventWireup="true" CodeBehind="ConCtaCorrente.aspx.cs" Inherits="SoftHabilInformatica.Pages.Financeiros.ConContaCorrente" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cttCorpo" runat="server">
    ...
    <div id="divNavTeste" style="padding-left:20px;padding-top:20px;padding-right:20px" >
        ...
        <div class="panel panel-primary" >
            <div  class="panel-heading">Consulta de Conta Corrente
...
c                                                    </div>
                        ...
                        <div role="tabpanel" class="tab-pane" id="consulta" style="padding-left:20px;padding-top:20px;padding-right:20px;font-size:small;"   >
                            ...
                            <asp:GridView ID="grdGrid" runat="server" CssClass="table table-bordered table-hover table-striped"
                                ...
                                <Columns>
                                    <asp:BoundField DataField="CodigoContaCorrente" HeaderText="Código" />
                                    
                                    <asp:BoundField DataField="DescricaoContaCorrente" HeaderText="Descrição" />
