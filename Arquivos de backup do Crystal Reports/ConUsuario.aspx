<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPrincipal.Master" AutoEventWireup="true" CodeBehind="ConUsuario.aspx.cs" Inherits="SoftHabilInformatica.Pages.Usuarios.ConUsuario" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cttCorpo" runat="server">
    ...
    <div id="divNavTeste" style="padding-left:20px;padding-top:20px;padding-right:20px" >
        ...
        <div class="panel panel-primary">
            <div class="panel-heading">Consulta de Usuários do Sistema</div>
            <div class="panel-body" style="max-height:430px;overflow-y: scroll;">
                ...
                <asp:GridView ID="grdUsuario" runat="server" Width="100%" 
                    ...
                    OnPageIndexChanging="grdUsuario_PageIndexChanging" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="NomeUsuario" HeaderText="Nome Completo" />
                        <asp:BoundField DataField="Login" HeaderText="Login" />
                        <asp:BoundField DataField="CodigoPerfil" HeaderText="Perfil" />
                        <asp:BoundField DataField="CodigoSituacao" HeaderText="Situação" />
