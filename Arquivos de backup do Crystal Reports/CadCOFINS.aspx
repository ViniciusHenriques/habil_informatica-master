<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPrincipal.Master" AutoEventWireup="true" CodeBehind="CadCOFINS.aspx.cs" Inherits="SoftHabilInformatica.Pages.Produtos.CadCOFINS" %>
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <asp:LinkButton ID="btnExcluir" runat="server" Text="Excluir" CssClass="btn btn-danger" data-toggle="modal" data-target="#myexcpes" TabIndex="7"> 
                    ...
                    <div class="col-md-3">
                        <label for="usr"> Código COFINS:  </label>
                    ...
                    <div class="col-md-3">
                        <label for="usr"> Valor do COFINS:  </label>
                        <asp:TextBox ID="txtVLCOFINS" CssClass="form-control" name="txtCodigo_TextChanged" Font-Size ="Medium" runat="server" TabIndex="3" MaxLength="4"/>
                    </div>

		               	  <div class="col-md-3">
                    <label for="usr"> Tipo: </label>
                               <asp:DropDownList ID="ddlCOFINS" runat="server" AutoPostBack="false"  CssClass="form-control js-example-basic-single" Font-Size="Small" TabIndex="4"> </asp:DropDownList>		   
                          </div> 
                      </div>
                <div class="row" style="margin-top: 10px">
                <div class="col-md-12">
                        <label for="usr"> Descrição COFINS: </label>
                        <asp:TextBox ID="txtDescricaoCOFINS"  CssClass="form-control" name="txtDescricaoPIS" TabIndex="5" runat="server"  MaxLength="150" TextMode="multiline" Columns="8" Rows="4"/>
                    </div>
