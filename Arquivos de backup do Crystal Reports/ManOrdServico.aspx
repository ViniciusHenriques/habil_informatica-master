                                                            ...
                                                            <asp:TemplateField HeaderText="Incluir OS">
                                                                <ItemTemplate>
                                                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Always">
                                                                        ...
                                                                        <ContentTemplate>
                                                                            <asp:LinkButton ID="btnAddOS" runat="server" title="Adicionar/Alterar OS" TabIndex="20" CssClass="btn btn-success" Style="height: 33px!important;" CommandName="btnAddOS" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" Visible='<%# Eval("BtnAdd") %>'> 
                                                                                <span aria-hidden="true"  class="glyphicon glyphicon-plus"></span>
                                                                            </asp:LinkButton>
                                                                            <asp:LinkButton ID="btnRemoverOS" runat="server" title="Remover OS" TabIndex="19" CssClass="btn btn-danger" Style="height: 33px!important;" CommandName="btnRemoveOS" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" Visible='<%# Eval("BtnRemove") %>'> 
