                                ...
                                <div id="divindicadores" style="padding-left: 100px; border: none; border-radius: 0px;">
                                    <asp:UpdatePanel ID="UpdatePanel6" runat="server" UpdateMode="Always">
                                        <ContentTemplate>
                                            ...
                                            <br />
                                            <asp:CheckBox ID="chkMovInterna" Text="&emsp;Movimentação Interna" CssClass="form-control-static" runat="server" onFocus="this.select()" Enabled="true" Font-Size="Small" value="2" />
                                            <br />
