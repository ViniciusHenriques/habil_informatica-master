                    ...
                    <asp:UpdatePanel ID="UpdatePanel6" runat="server" UpdateMode="Always">
                        <ContentTemplate>
                            <div class="col-md-4" style="background-color: white; border: none; text-align: left; font-size: small;">
                                <asp:LinkButton ID="btnVoltar" runat="server" Text="Voltar" CssClass="btn btn-info" TabIndex="0" UseSubmitBehavior="false" OnClick="btnVoltar_Click" Height ="60"> 
                                    <span aria-hidden="true" title="Voltar" class="glyphicon glyphicon-arrow-left"></span><br/><br/>&nbsp;Voltar  
                                </asp:LinkButton>
                                <asp:LinkButton ID="btnSalvar" runat="server" Text="Salvar" CssClass="btn btn-success" TabIndex="1" UseSubmitBehavior="false"  Height ="60" OnClick="btnSalvar_Click"> 
                                    <span aria-hidden="true" title="Salvar" class="glyphicon glyphicon-save"></span><br/><br/>&nbsp;Salvar  
                                </asp:LinkButton>
                                <asp:LinkButton ID="btnEncaminhar" runat="server" Text="Salvar" CssClass="btn btn-info" TabIndex="1" UseSubmitBehavior="false"  Height ="60" OnClick="btnEncaminhar_Click"> 
                                    <span aria-hidden="true" title="Salvar" class="glyphicon glyphicon-repeat"></span><br/><br/>&nbsp;Encaminhar
                                </asp:LinkButton>
                                <asp:LinkButton ID="btnEnviar" runat="server" Text="Enviar" CssClass="btn btn-warning" TabIndex="1" UseSubmitBehavior="false"  Height ="60" OnClick="btnEnviar_Click"> 
                                    <span aria-hidden="true" title="Salvar" class="glyphicon glyphicon-envelope"></span><br/><br/>&nbsp;Enviar  
                                </asp:LinkButton>
                            </div>
                            ...
                            <div class="col-md-2" style="background-color: white; border: none; text-align: left; font-size:x-small;">
                                ...
                                <asp:TextBox ID="txtDataLancamento" CssClass="form-control" runat="server" Enabled="false" Text ="" Font-Size="Small" TabIndex="2"/>
                            </div>
                            <div class="col-md-2" style="background-color: white; border: none; text-align: left; font-size:x-small;">
                                <label for="usr" style ="margin-top:-1px;" class="acao">Situação</label>
                                <asp:DropDownList ID="ddlSituacao" runat="server" AutoPostBack="True" Enabled ="false"  CssClass="form-control js-example-basic-single" TabIndex="2" Font-Size="Small">
                                </asp:DropDownList>
                            </div>
                            <div class="col-md-2" style="background-color: white; border: none; text-align: left; font-size:x-small;">
                                <label for="usr" style ="margin-top:-1px;" class="acao">Data Envio</label>
                                <asp:TextBox ID="txtDataEnvio" CssClass="form-control" runat="server" Enabled="false" Text ="" Font-Size="Small" TabIndex="2"/>
                            </div>
                            <div class="col-md-1" style="background-color: white; border: none; text-align: left; font-size:x-small;">
                                <label for="usr" style ="margin-top:-1px;" class="acao">Tentativas Envio</label>
                                <asp:TextBox ID="txtTentaEnvio" CssClass="form-control" runat="server" Enabled="false" Text ="" Font-Size="Small" TabIndex="2"/>
                    ...
                    <ContentTemplate>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-heading" >
                                ...
                                <asp:LinkButton runat="server" title="Editar Contatos" ID="btnAnexo" OnClick="btnAnexo_Click" CssClass="btn btn-info" style="height:33px; margin-right:20px;float:left;margin-top:-8px" TabIndex="17">
                                        ...
                                        <div class="col-md-2" style="background-color: white; border: none; text-align: left; font-size: small;">
                                            ...
                                            <br/>
                                                <asp:LinkButton ID="btnSalvarContato" runat="server" Text="Salvar Contato" CssClass="btn btn-success" TabIndex="1" UseSubmitBehavior="false" Height ="33"  OnClick="btnSalvarContato_Click"> 
                                                    <span aria-hidden="true" title="Salvar" class="glyphicon glyphicon-save"></span>  
                                                </asp:LinkButton>
                                                <asp:LinkButton ID="btnVoltarContato" runat="server" Text="Voltar" CssClass="btn btn-info" TabIndex="0" UseSubmitBehavior="false" OnClick="btnVoltarContato_Click" Height ="33"> 
                                                    <span aria-hidden="true" title="Voltar" class="glyphicon glyphicon-arrow-left"></span>  
                                                </asp:LinkButton>
