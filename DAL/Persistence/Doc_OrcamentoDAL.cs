...
{
    public class Doc_OrcamentoDAL : Conexao
    {
        protected string strSQL = "";
        public void Inserir(Doc_Orcamento p, List<ProdutoDocumento> listaItemOrcamento, EventoDocumento eventoDocumento, List<AnexoDocumento> ListaAnexoDocumento)
        {
            try
            {
                AbrirConexao();
                ...
                Cmd.Parameters.AddWithValue("@v1", 5);
            ...
            {
                throw new Exception("Erro ao gravar Orcamento: " + ex.Message.ToString());
            }
            finally
            {
                FecharConexao();
        ...
        public void Atualizar(Doc_Orcamento p, List<ProdutoDocumento> listaItemOrcamento, EventoDocumento eventoDocumento, List<AnexoDocumento> ListaAnexoDocumento)
        {
            try
            {
                Doc_Orcamento p2 = new Doc_Orcamento();
                p2 = PesquisarOrcamento(Convert.ToInt32(p.CodigoDocumento));
                GerarLog(p, p2);
                AbrirConexao();
        ...
        public void AtualizarSituacao(decimal CodigoDocumento, int CodigoSituacaoNova, int CodigoSituacaoAnterior, int CodigoUsuario, int CodigoMaquina)
        {
            ...
            {
                throw new Exception("Erro ao atualizar situacao do  ORCAMENTO: " + ex.Message.ToString());
            }
        ...
        public Doc_Orcamento PesquisarOrcamento(decimal Codigo)
        {
            try
            {
                ...
                AbrirConexao();
                strSQL = "Select * from [VW_DOC_ORCAMENTO] Where CD_DOCUMENTO= @v1";
                Cmd = new SqlCommand(strSQL, Con);
                Cmd.Parameters.AddWithValue("@v1", Codigo);
                Dr = Cmd.ExecuteReader();
                Doc_Orcamento p = null;
            ...
            {
                throw new Exception("Erro ao Pesquisar Doc_Orcamento: " + ex.Message.ToString());
            }
            finally
            {
                FecharConexao();
        ...
        public List<Doc_CtaReceber> ListarContasAbertasCliente(decimal CodigoPessoa)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception("Erro ao Listar CONTAS A RECEBER DO ORCAMENTO: " + ex.Message.ToString());
            }
            finally
            {
                FecharConexao();
        ...
        public List<Doc_Orcamento> ListarOrcamento(string strNomeCampo, string strTipoCampo, string strValor, string strOrdem)
        {
            try
            {
                AbrirConexao();

                string strSQL = "Select * from [VW_DOC_ORCAMENTO] ";
                ...
                List<Doc_Orcamento> lista = new List<Doc_Orcamento>();
        ...
        public List<Doc_Orcamento> ListarOrcamentoPessoa(long CodigoPessoa, decimal CodigoDocumentoAtual)
        {
            try
            {
                AbrirConexao();

                string strSQL = "Select * from [VW_DOC_ORCAMENTO] where CD_PESSOA = @v1 AND CD_DOCUMENTO != @v2 ORDER BY CD_DOCUMENTO DESC";
        ...
        public List<Doc_Orcamento> ListarOrcamentosCompleto(List<DBTabelaCampos> ListaFiltros)
        {
            try
            {
                AbrirConexao();
        ...
        public DataTable RelOrcamento(decimal CodigoDocumento)
        {
            try
            {
                //// Cria DataTable
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception("Erro ao Listar Relatório de orcamento: " + ex.Message.ToString());
            }
            finally
            {
                FecharConexao();
        ...
        public void GerarLog(Doc_Orcamento p1, Doc_Orcamento p2)
        {
        ...
        public void EventoDocumento(Doc_Orcamento doc, int CodigoSituacao)
        {
        ...
        public DataTable RelOrcamentoCompleto(List<DBTabelaCampos> ListaFiltros)
        {
            try
            {
                //// Cria DataTable
                ...
                strSQL = strSQL + " ORDER BY DS_SITUACAO DESC ";
                AbrirConexao();
                SqlCommand cmd = new SqlCommand(strSQL, Con);
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                da.Fill(dt);
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception("Erro ao Listar Relatório de orçamento: " + ex.Message.ToString());
            }
            finally
            {
                FecharConexao();
